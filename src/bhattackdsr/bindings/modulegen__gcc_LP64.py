...
def module_init():
    root_module = Module('ns.bhattackdsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## bhattackdsr-helper.h (module 'bhattackdsr'): ns3::BhattackdsrHelper [class]
    module.add_class('BhattackdsrHelper')
    ## bhattackdsr-main-helper.h (module 'bhattackdsr'): ns3::BhattackdsrMainHelper [class]
    module.add_class('BhattackdsrMainHelper')
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', template_parameters=['void', 'const ns3::bhattackdsr::BhattackdsrOptionSRHeader &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'], parent=root_module['ns3::CallbackImplBase'])
    ...
    ## Register a nested module for the namespace bhattackdsr
    
    nested_module = module.add_cpp_namespace('bhattackdsr')
    register_types_ns3_bhattackdsr(nested_module)
...
def register_types_ns3_bhattackdsr(module):
    root_module = module.get_root()
    
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkStates [enumeration]
    module.add_enum('LinkStates', ['PROBABLE', 'QUESTIONABLE'])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMessageType [enumeration]
    module.add_enum('BhattackdsrMessageType', ['DSR_CONTROL_PACKET', 'DSR_DATA_PACKET'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::ErrorType [enumeration]
    module.add_enum('ErrorType', ['NODE_UNREACHABLE', 'FLOW_STATE_NOT_SUPPORTED', 'OPTION_NOT_SUPPORTED'])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList [struct]
    module.add_class('BlackList')
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffEntry [class]
    module.add_class('BhattackdsrErrorBuffEntry')
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffer [class]
    module.add_class('BhattackdsrErrorBuffer')
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrFsHeader [class]
    module.add_class('BhattackdsrFsHeader', parent=root_module['ns3::Header'])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrGraReply [class]
    module.add_class('BhattackdsrGraReply', parent=root_module['ns3::Object'])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrLinkStab [class]
    module.add_class('BhattackdsrLinkStab')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffEntry [class]
    module.add_class('BhattackdsrMaintainBuffEntry')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffer [class]
    module.add_class('BhattackdsrMaintainBuffer')
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueue [class]
    module.add_class('BhattackdsrNetworkQueue', parent=root_module['ns3::Object'])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueueEntry [class]
    module.add_class('BhattackdsrNetworkQueueEntry')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNodeStab [class]
    module.add_class('BhattackdsrNodeStab')
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionField [class]
    module.add_class('BhattackdsrOptionField')
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader [class]
    module.add_class('BhattackdsrOptionHeader', parent=root_module['ns3::Header'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment [struct]
    module.add_class('Alignment', outer_class=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1Header [class]
    module.add_class('BhattackdsrOptionPad1Header', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadnHeader [class]
    module.add_class('BhattackdsrOptionPadnHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrHeader [class]
    module.add_class('BhattackdsrOptionRerrHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader [class]
    module.add_class('BhattackdsrOptionRerrUnreachHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionRerrHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader [class]
    module.add_class('BhattackdsrOptionRerrUnsupportHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionRerrHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrepHeader [class]
    module.add_class('BhattackdsrOptionRrepHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreqHeader [class]
    module.add_class('BhattackdsrOptionRreqHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSRHeader [class]
    module.add_class('BhattackdsrOptionSRHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    typehandlers.add_type_alias(u'void ( * ) ( ns3::bhattackdsr::BhattackdsrOptionSRHeader const & )', u'ns3::bhattackdsr::BhattackdsrOptionSRHeader::TracedCallback')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::bhattackdsr::BhattackdsrOptionSRHeader const & )*', u'ns3::bhattackdsr::BhattackdsrOptionSRHeader::TracedCallback*')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::bhattackdsr::BhattackdsrOptionSRHeader const & )&', u'ns3::bhattackdsr::BhattackdsrOptionSRHeader::TracedCallback&')
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptions [class]
    module.add_class('BhattackdsrOptions', parent=root_module['ns3::Object'])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffEntry [class]
    module.add_class('BhattackdsrPassiveBuffEntry')
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffer [class]
    module.add_class('BhattackdsrPassiveBuffer', parent=root_module['ns3::Object'])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrReceivedRreqEntry [class]
    module.add_class('BhattackdsrReceivedRreqEntry')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache [class]
    module.add_class('BhattackdsrRouteCache', parent=root_module['ns3::Object'])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::bhattackdsr::BhattackdsrRouteCache'])
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >', u'ns3::bhattackdsr::BhattackdsrRouteCache::routeVector')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >*', u'ns3::bhattackdsr::BhattackdsrRouteCache::routeVector*')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >&', u'ns3::bhattackdsr::BhattackdsrRouteCache::routeVector&')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCacheEntry [class]
    module.add_class('BhattackdsrRouteCacheEntry')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >*', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >&', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR&')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::Iterator')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator*', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::Iterator*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator&', u'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::Iterator&')
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouting [class]
    module.add_class('BhattackdsrRouting', parent=root_module['ns3::IpL4Protocol'])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRoutingHeader [class]
    module.add_class('BhattackdsrRoutingHeader', parent=[root_module['ns3::bhattackdsr::BhattackdsrFsHeader'], root_module['ns3::bhattackdsr::BhattackdsrOptionField']])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRreqTable [class]
    module.add_class('BhattackdsrRreqTable', parent=root_module['ns3::Object'])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffEntry [class]
    module.add_class('BhattackdsrSendBuffEntry')
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffer [class]
    module.add_class('BhattackdsrSendBuffer')
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry [struct]
    module.add_class('GraReplyEntry')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::Link [struct]
    module.add_class('Link')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey [struct]
    module.add_class('LinkKey')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey [struct]
    module.add_class('NetworkKey')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey [struct]
    module.add_class('PassiveKey')
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::RreqTableEntry [struct]
    module.add_class('RreqTableEntry')
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAck [class]
    module.add_class('BhattackdsrOptionAck', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckHeader [class]
    module.add_class('BhattackdsrOptionAckHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReq [class]
    module.add_class('BhattackdsrOptionAckReq', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReqHeader [class]
    module.add_class('BhattackdsrOptionAckReqHeader', parent=root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1 [class]
    module.add_class('BhattackdsrOptionPad1', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadn [class]
    module.add_class('BhattackdsrOptionPadn', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerr [class]
    module.add_class('BhattackdsrOptionRerr', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrep [class]
    module.add_class('BhattackdsrOptionRrep', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreq [class]
    module.add_class('BhattackdsrOptionRreq', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSR [class]
    module.add_class('BhattackdsrOptionSR', parent=root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    module.add_container('std::vector< ns3::bhattackdsr::BhattackdsrErrorBuffEntry >', 'ns3::bhattackdsr::BhattackdsrErrorBuffEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::bhattackdsr::BhattackdsrNetworkQueueEntry >', 'ns3::bhattackdsr::BhattackdsrNetworkQueueEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::Ipv4Address >', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::list< ns3::bhattackdsr::BhattackdsrRouteCacheEntry >', 'ns3::bhattackdsr::BhattackdsrRouteCacheEntry', container_type=u'list')
    module.add_container('std::list< std::vector< ns3::Ipv4Address > >', 'std::vector< ns3::Ipv4Address >', container_type=u'list')
    module.add_container('ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::vector< ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor >', 'ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor', container_type=u'vector')
    ...
    module.add_container('std::vector< ns3::bhattackdsr::BhattackdsrSendBuffEntry >', 'ns3::bhattackdsr::BhattackdsrSendBuffEntry', container_type=u'vector')
...
def register_methods(root_module):
    ...
    register_Ns3BhattackdsrHelper_methods(root_module, root_module['ns3::BhattackdsrHelper'])
    register_Ns3BhattackdsrMainHelper_methods(root_module, root_module['ns3::BhattackdsrMainHelper'])
    ...
    register_Ns3CallbackImpl__Void_Const_ns3BhattackdsrBhattackdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3BhattackdsrBlackList_methods(root_module, root_module['ns3::bhattackdsr::BlackList'])
    register_Ns3BhattackdsrBhattackdsrErrorBuffEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrErrorBuffEntry'])
    register_Ns3BhattackdsrBhattackdsrErrorBuffer_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrErrorBuffer'])
    register_Ns3BhattackdsrBhattackdsrFsHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrFsHeader'])
    register_Ns3BhattackdsrBhattackdsrGraReply_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrGraReply'])
    register_Ns3BhattackdsrBhattackdsrLinkStab_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrLinkStab'])
    register_Ns3BhattackdsrBhattackdsrMaintainBuffEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrMaintainBuffEntry'])
    register_Ns3BhattackdsrBhattackdsrMaintainBuffer_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrMaintainBuffer'])
    register_Ns3BhattackdsrBhattackdsrNetworkQueue_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrNetworkQueue'])
    register_Ns3BhattackdsrBhattackdsrNetworkQueueEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrNetworkQueueEntry'])
    register_Ns3BhattackdsrBhattackdsrNodeStab_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrNodeStab'])
    register_Ns3BhattackdsrBhattackdsrOptionField_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionField'])
    register_Ns3BhattackdsrBhattackdsrOptionHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionHeaderAlignment_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment'])
    register_Ns3BhattackdsrBhattackdsrOptionPad1Header_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionPad1Header'])
    register_Ns3BhattackdsrBhattackdsrOptionPadnHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionPadnHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionRerrHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRerrHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionRerrUnreachHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionRerrUnsupportHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionRrepHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRrepHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionRreqHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRreqHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionSRHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionSRHeader'])
    register_Ns3BhattackdsrBhattackdsrOptions_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptions'])
    register_Ns3BhattackdsrBhattackdsrPassiveBuffEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrPassiveBuffEntry'])
    register_Ns3BhattackdsrBhattackdsrPassiveBuffer_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrPassiveBuffer'])
    register_Ns3BhattackdsrBhattackdsrReceivedRreqEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrReceivedRreqEntry'])
    register_Ns3BhattackdsrBhattackdsrRouteCache_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRouteCache'])
    register_Ns3BhattackdsrBhattackdsrRouteCacheNeighbor_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor'])
    register_Ns3BhattackdsrBhattackdsrRouteCacheEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRouteCacheEntry'])
    register_Ns3BhattackdsrBhattackdsrRouting_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRouting'])
    register_Ns3BhattackdsrBhattackdsrRoutingHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRoutingHeader'])
    register_Ns3BhattackdsrBhattackdsrRreqTable_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrRreqTable'])
    register_Ns3BhattackdsrBhattackdsrSendBuffEntry_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrSendBuffEntry'])
    register_Ns3BhattackdsrBhattackdsrSendBuffer_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrSendBuffer'])
    register_Ns3BhattackdsrGraReplyEntry_methods(root_module, root_module['ns3::bhattackdsr::GraReplyEntry'])
    register_Ns3BhattackdsrLink_methods(root_module, root_module['ns3::bhattackdsr::Link'])
    register_Ns3BhattackdsrLinkKey_methods(root_module, root_module['ns3::bhattackdsr::LinkKey'])
    register_Ns3BhattackdsrNetworkKey_methods(root_module, root_module['ns3::bhattackdsr::NetworkKey'])
    register_Ns3BhattackdsrPassiveKey_methods(root_module, root_module['ns3::bhattackdsr::PassiveKey'])
    register_Ns3BhattackdsrRreqTableEntry_methods(root_module, root_module['ns3::bhattackdsr::RreqTableEntry'])
    register_Ns3BhattackdsrBhattackdsrOptionAck_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionAck'])
    register_Ns3BhattackdsrBhattackdsrOptionAckHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionAckHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionAckReq_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionAckReq'])
    register_Ns3BhattackdsrBhattackdsrOptionAckReqHeader_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionAckReqHeader'])
    register_Ns3BhattackdsrBhattackdsrOptionPad1_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionPad1'])
    register_Ns3BhattackdsrBhattackdsrOptionPadn_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionPadn'])
    register_Ns3BhattackdsrBhattackdsrOptionRerr_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRerr'])
    register_Ns3BhattackdsrBhattackdsrOptionRrep_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRrep'])
    register_Ns3BhattackdsrBhattackdsrOptionRreq_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionRreq'])
    register_Ns3BhattackdsrBhattackdsrOptionSR_methods(root_module, root_module['ns3::bhattackdsr::BhattackdsrOptionSR'])
    return
...
def register_Ns3BhattackdsrHelper_methods(root_module, cls):
    ## bhattackdsr-helper.h (module 'bhattackdsr'): ns3::BhattackdsrHelper::BhattackdsrHelper() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-helper.h (module 'bhattackdsr'): ns3::BhattackdsrHelper::BhattackdsrHelper(ns3::BhattackdsrHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::BhattackdsrHelper const &', 'arg0')])
    ## bhattackdsr-helper.h (module 'bhattackdsr'): ns3::BhattackdsrHelper * ns3::BhattackdsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::BhattackdsrHelper *', 
                   [], 
                   is_const=True)
    ## bhattackdsr-helper.h (module 'bhattackdsr'): ns3::Ptr<ns3::bhattackdsr::BhattackdsrRouting> ns3::BhattackdsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::bhattackdsr::BhattackdsrRouting >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## bhattackdsr-helper.h (module 'bhattackdsr'): void ns3::BhattackdsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return

def register_Ns3BhattackdsrMainHelper_methods(root_module, cls):
    ## bhattackdsr-main-helper.h (module 'bhattackdsr'): ns3::BhattackdsrMainHelper::BhattackdsrMainHelper() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-main-helper.h (module 'bhattackdsr'): ns3::BhattackdsrMainHelper::BhattackdsrMainHelper(ns3::BhattackdsrMainHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::BhattackdsrMainHelper const &', 'arg0')])
    ## bhattackdsr-main-helper.h (module 'bhattackdsr'): void ns3::BhattackdsrMainHelper::Install(ns3::BhattackdsrHelper & bhattackdsrHelper, ns3::NodeContainer nodes) [member function]
    cls.add_method('Install', 
                   'void', 
                   [param('ns3::BhattackdsrHelper &', 'bhattackdsrHelper'), param('ns3::NodeContainer', 'nodes')])
    ## bhattackdsr-main-helper.h (module 'bhattackdsr'): void ns3::BhattackdsrMainHelper::SetBhattackdsrHelper(ns3::BhattackdsrHelper & bhattackdsrHelper) [member function]
    cls.add_method('SetBhattackdsrHelper', 
                   'void', 
                   [param('ns3::BhattackdsrHelper &', 'bhattackdsrHelper')])
    return
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, visibility='protected', template_parameters=[u'ns3::bhattackdsr::BhattackdsrOptionSRHeader const&'])
    return
...
def register_Ns3CallbackImpl__Void_Const_ns3BhattackdsrBhattackdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::bhattackdsr::BhattackdsrOptionSRHeader const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, const ns3::bhattackdsr::BhattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::bhattackdsr::BhattackdsrOptionSRHeader const & arg0) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrOptionSRHeader const &', 'arg0')], 
                   is_pure_virtual=True, is_virtual=True, custom_name=u'__call__')
    return
...
def register_Ns3BhattackdsrBlackList_methods(root_module, cls):
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList::BlackList(ns3::bhattackdsr::BlackList const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BlackList const &', 'arg0')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList::BlackList(ns3::Ipv4Address ip, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Time', 't')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList::m_linkStates [variable]
    cls.add_instance_attribute('m_linkStates', 'ns3::bhattackdsr::LinkStates', is_const=False)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrBhattackdsrErrorBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffEntry::BhattackdsrErrorBuffEntry(ns3::bhattackdsr::BhattackdsrErrorBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrErrorBuffEntry const &', 'arg0')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffEntry::BhattackdsrErrorBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Ptr<const ns3::Packet> ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrErrorBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3BhattackdsrBhattackdsrErrorBuffer_methods(root_module, cls):
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffer::BhattackdsrErrorBuffer(ns3::bhattackdsr::BhattackdsrErrorBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrErrorBuffer const &', 'arg0')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrErrorBuffer::BhattackdsrErrorBuffer() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrErrorBuffer::Dequeue(ns3::Ipv4Address dst, ns3::bhattackdsr::BhattackdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::bhattackdsr::BhattackdsrErrorBuffEntry &', 'entry')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffer::DropPacketForErrLink(ns3::Ipv4Address source, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketForErrLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrErrorBuffer::Enqueue(ns3::bhattackdsr::BhattackdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrErrorBuffEntry &', 'entry')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrErrorBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): std::vector<ns3::bhattackdsr::BhattackdsrErrorBuffEntry, std::allocator<ns3::bhattackdsr::BhattackdsrErrorBuffEntry> > & ns3::bhattackdsr::BhattackdsrErrorBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::bhattackdsr::BhattackdsrErrorBuffEntry > &', 
                   [])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrErrorBuffer::GetErrorBufferTimeout() const [member function]
    cls.add_method('GetErrorBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrErrorBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrErrorBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffer::SetErrorBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetErrorBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## bhattackdsr-errorbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrErrorBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3BhattackdsrBhattackdsrFsHeader_methods(root_module, cls):
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrFsHeader::BhattackdsrFsHeader(ns3::bhattackdsr::BhattackdsrFsHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrFsHeader const &', 'arg0')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrFsHeader::BhattackdsrFsHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrFsHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrFsHeader::GetDestId() const [member function]
    cls.add_method('GetDestId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrFsHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrFsHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrFsHeader::GetNextHeader() const [member function]
    cls.add_method('GetNextHeader', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrFsHeader::GetPayloadLength() const [member function]
    cls.add_method('GetPayloadLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrFsHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrFsHeader::GetSourceId() const [member function]
    cls.add_method('GetSourceId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrFsHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::SetDestId(uint16_t destId) [member function]
    cls.add_method('SetDestId', 
                   'void', 
                   [param('uint16_t', 'destId')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::SetMessageType(uint8_t messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('uint8_t', 'messageType')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::SetNextHeader(uint8_t protocol) [member function]
    cls.add_method('SetNextHeader', 
                   'void', 
                   [param('uint8_t', 'protocol')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::SetPayloadLength(uint16_t length) [member function]
    cls.add_method('SetPayloadLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrFsHeader::SetSourceId(uint16_t sourceId) [member function]
    cls.add_method('SetSourceId', 
                   'void', 
                   [param('uint16_t', 'sourceId')])
    return

def register_Ns3BhattackdsrBhattackdsrGraReply_methods(root_module, cls):
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrGraReply::BhattackdsrGraReply(ns3::bhattackdsr::BhattackdsrGraReply const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrGraReply const &', 'arg0')])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrGraReply::BhattackdsrGraReply() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrGraReply::AddEntry(ns3::bhattackdsr::GraReplyEntry & graTableEntry) [member function]
    cls.add_method('AddEntry', 
                   'bool', 
                   [param('ns3::bhattackdsr::GraReplyEntry &', 'graTableEntry')])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrGraReply::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrGraReply::FindAndUpdate(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, ns3::Time gratReplyHoldoff) [member function]
    ...
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrGraReply::GetGraTableSize() const [member function]
    cls.add_method('GetGraTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrGraReply::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrGraReply::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrGraReply::SetGraTableSize(uint32_t g) [member function]
    cls.add_method('SetGraTableSize', 
                   'void', 
                   [param('uint32_t', 'g')])
    return

def register_Ns3BhattackdsrBhattackdsrLinkStab_methods(root_module, cls):
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrLinkStab::BhattackdsrLinkStab(ns3::bhattackdsr::BhattackdsrLinkStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrLinkStab const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrLinkStab::BhattackdsrLinkStab(ns3::Time linkStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'linkStab', default_value='ns3::Simulator::Now()')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrLinkStab::GetLinkStability() const [member function]
    cls.add_method('GetLinkStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrLinkStab::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrLinkStab::SetLinkStability(ns3::Time linkStab) [member function]
    cls.add_method('SetLinkStability', 
                   'void', 
                   [param('ns3::Time', 'linkStab')])
    return

def register_Ns3BhattackdsrBhattackdsrMaintainBuffEntry_methods(root_module, cls):
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::BhattackdsrMaintainBuffEntry(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry const &', 'arg0')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::BhattackdsrMaintainBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address us=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address dst=ns3::Ipv4Address(), uint16_t ackId=0, uint8_t segs=0, ns3::Time exp=ns3::Simulator::Now()) [constructor]
    ...
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetOurAdd() const [member function]
    cls.add_method('GetOurAdd', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Ptr<const ns3::Packet> ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::GetSrc() const [member function]
    cls.add_method('GetSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetAckId(uint16_t ackId) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'ackId')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetDst(ns3::Ipv4Address n) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetOurAdd(ns3::Ipv4Address us) [member function]
    cls.add_method('SetOurAdd', 
                   'void', 
                   [param('ns3::Ipv4Address', 'us')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetSegsLeft(uint8_t segs) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'segs')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffEntry::SetSrc(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3BhattackdsrBhattackdsrMaintainBuffer_methods(root_module, cls):
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffer::BhattackdsrMaintainBuffer(ns3::bhattackdsr::BhattackdsrMaintainBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrMaintainBuffer const &', 'arg0')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrMaintainBuffer::BhattackdsrMaintainBuffer() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::AllEqual(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::Dequeue(ns3::Ipv4Address dst, ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffer::DropPacketWithNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::Enqueue(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrMaintainBuffer::GetMaintainBufferTimeout() const [member function]
    cls.add_method('GetMaintainBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrMaintainBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrMaintainBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::LinkEqual(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('LinkEqual', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::NetworkEqual(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('NetworkEqual', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrMaintainBuffer::PromiscEqual(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('PromiscEqual', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'entry')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffer::SetMaintainBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetMaintainBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrMaintainBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3BhattackdsrBhattackdsrNetworkQueue_methods(root_module, cls):
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueue::BhattackdsrNetworkQueue(ns3::bhattackdsr::BhattackdsrNetworkQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrNetworkQueue const &', 'arg0')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueue::BhattackdsrNetworkQueue() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueue::BhattackdsrNetworkQueue(uint32_t maxLen, ns3::Time maxDelay) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'maxDelay')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrNetworkQueue::Dequeue(ns3::bhattackdsr::BhattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrNetworkQueueEntry &', 'entry')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrNetworkQueue::Enqueue(ns3::bhattackdsr::BhattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrNetworkQueueEntry &', 'entry')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrNetworkQueue::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrNetworkQueue::FindPacketWithNexthop(ns3::Ipv4Address nextHop, ns3::bhattackdsr::BhattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('FindPacketWithNexthop', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::bhattackdsr::BhattackdsrNetworkQueueEntry &', 'entry')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueue::Flush() [member function]
    cls.add_method('Flush', 
                   'void', 
                   [])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrNetworkQueue::GetMaxNetworkDelay() const [member function]
    cls.add_method('GetMaxNetworkDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrNetworkQueue::GetMaxNetworkSize() const [member function]
    cls.add_method('GetMaxNetworkSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): std::vector<ns3::bhattackdsr::BhattackdsrNetworkQueueEntry, std::allocator<ns3::bhattackdsr::BhattackdsrNetworkQueueEntry> > & ns3::bhattackdsr::BhattackdsrNetworkQueue::GetQueue() [member function]
    cls.add_method('GetQueue', 
                   'std::vector< ns3::bhattackdsr::BhattackdsrNetworkQueueEntry > &', 
                   [])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrNetworkQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrNetworkQueue::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueue::SetMaxNetworkDelay(ns3::Time delay) [member function]
    cls.add_method('SetMaxNetworkDelay', 
                   'void', 
                   [param('ns3::Time', 'delay')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueue::SetMaxNetworkSize(uint32_t maxSize) [member function]
    cls.add_method('SetMaxNetworkSize', 
                   'void', 
                   [param('uint32_t', 'maxSize')])
    return

def register_Ns3BhattackdsrBhattackdsrNetworkQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::BhattackdsrNetworkQueueEntry(ns3::bhattackdsr::BhattackdsrNetworkQueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrNetworkQueueEntry const &', 'arg0')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::BhattackdsrNetworkQueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), ns3::Ptr<ns3::Ipv4Route> r=0) [constructor]
    ...
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::GetInsertedTimeStamp() const [member function]
    cls.add_method('GetInsertedTimeStamp', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::GetIpv4Route() const [member function]
    cls.add_method('GetIpv4Route', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::GetNextHopAddress() const [member function]
    cls.add_method('GetNextHopAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Ptr<const ns3::Packet> ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::GetSourceAddress() const [member function]
    cls.add_method('GetSourceAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::SetInsertedTimeStamp(ns3::Time time) [member function]
    cls.add_method('SetInsertedTimeStamp', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::SetIpv4Route(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetIpv4Route', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::SetNextHopAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNextHopAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## bhattackdsr-network-queue.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNetworkQueueEntry::SetSourceAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetSourceAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    return

def register_Ns3BhattackdsrBhattackdsrNodeStab_methods(root_module, cls):
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNodeStab::BhattackdsrNodeStab(ns3::bhattackdsr::BhattackdsrNodeStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrNodeStab const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrNodeStab::BhattackdsrNodeStab(ns3::Time nodeStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'nodeStab', default_value='ns3::Simulator::Now()')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrNodeStab::GetNodeStability() const [member function]
    cls.add_method('GetNodeStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrNodeStab::SetNodeStability(ns3::Time nodeStab) [member function]
    cls.add_method('SetNodeStability', 
                   'void', 
                   [param('ns3::Time', 'nodeStab')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionField_methods(root_module, cls):
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionField::BhattackdsrOptionField(ns3::bhattackdsr::BhattackdsrOptionField const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionField const &', 'arg0')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionField::BhattackdsrOptionField(uint32_t optionsOffset) [constructor]
    cls.add_constructor([param('uint32_t', 'optionsOffset')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionField::AddBhattackdsrOption(ns3::bhattackdsr::BhattackdsrOptionHeader const & option) [member function]
    cls.add_method('AddBhattackdsrOption', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrOptionHeader const &', 'option')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionField::Deserialize(ns3::Buffer::Iterator start, uint32_t length) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'length')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::Buffer ns3::bhattackdsr::BhattackdsrOptionField::GetBhattackdsrOptionBuffer() [member function]
    cls.add_method('GetBhattackdsrOptionBuffer', 
                   'ns3::Buffer', 
                   [])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionField::GetBhattackdsrOptionsOffset() [member function]
    cls.add_method('GetBhattackdsrOptionsOffset', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionField::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionField::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
...
def register_Ns3BhattackdsrBhattackdsrOptionHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::BhattackdsrOptionHeader(ns3::bhattackdsr::BhattackdsrOptionHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::BhattackdsrOptionHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionHeader::GetLength() const [member function]
    cls.add_method('GetLength', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionHeader::GetType() const [member function]
    cls.add_method('GetType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionHeader::SetLength(uint8_t length) [member function]
    cls.add_method('SetLength', 
                   'void', 
                   [param('uint8_t', 'length')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionHeader::SetType(uint8_t type) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('uint8_t', 'type')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionHeaderAlignment_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment::Alignment() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment::Alignment(ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment::factor [variable]
    cls.add_instance_attribute('factor', 'uint8_t', is_const=False)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment::offset [variable]
    cls.add_instance_attribute('offset', 'uint8_t', is_const=False)
    return

def register_Ns3BhattackdsrBhattackdsrOptionPad1Header_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1Header::BhattackdsrOptionPad1Header(ns3::bhattackdsr::BhattackdsrOptionPad1Header const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionPad1Header const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1Header::BhattackdsrOptionPad1Header() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionPad1Header::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPad1Header::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionPad1Header::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPad1Header::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionPad1Header::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionPad1Header::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3BhattackdsrBhattackdsrOptionPadnHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadnHeader::BhattackdsrOptionPadnHeader(ns3::bhattackdsr::BhattackdsrOptionPadnHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionPadnHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadnHeader::BhattackdsrOptionPadnHeader(uint32_t pad=2) [constructor]
    cls.add_constructor([param('uint32_t', 'pad', default_value='2')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionPadnHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPadnHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionPadnHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPadnHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionPadnHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionPadnHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3BhattackdsrBhattackdsrOptionRerrHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrHeader::BhattackdsrOptionRerrHeader(ns3::bhattackdsr::BhattackdsrOptionRerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRerrHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrHeader::BhattackdsrOptionRerrHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetErrorType() const [member function]
    cls.add_method('GetErrorType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::SetErrorType(uint8_t errorType) [member function]
    cls.add_method('SetErrorType', 
                   'void', 
                   [param('uint8_t', 'errorType')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrHeader::SetSalvage(uint8_t salvage) [member function]
...
def register_Ns3BhattackdsrBhattackdsrOptionRerrUnreachHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::BhattackdsrOptionRerrUnreachHeader(ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::BhattackdsrOptionRerrUnreachHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetOriginalDst() const [member function]
    cls.add_method('GetOriginalDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::GetUnreachNode() const [member function]
    cls.add_method('GetUnreachNode', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::SetOriginalDst(ns3::Ipv4Address originalDst) [member function]
    cls.add_method('SetOriginalDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originalDst')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader::SetUnreachNode(ns3::Ipv4Address unreachNode) [member function]
    cls.add_method('SetUnreachNode', 
                   'void', 
                   [param('ns3::Ipv4Address', 'unreachNode')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionRerrUnsupportHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::BhattackdsrOptionRerrUnsupportHeader(ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::BhattackdsrOptionRerrUnsupportHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::GetUnsupported() const [member function]
    cls.add_method('GetUnsupported', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRerrUnsupportHeader::SetUnsupported(uint16_t optionType) [member function]
    cls.add_method('SetUnsupported', 
                   'void', 
                   [param('uint16_t', 'optionType')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionRrepHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrepHeader::BhattackdsrOptionRrepHeader(ns3::bhattackdsr::BhattackdsrOptionRrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRrepHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrepHeader::BhattackdsrOptionRrepHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetTargetAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) const [member function]
    cls.add_method('GetTargetAddress', 
                   'ns3::Ipv4Address', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRrepHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRrepHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRrepHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionRreqHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreqHeader::BhattackdsrOptionRreqHeader(ns3::bhattackdsr::BhattackdsrOptionRreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRreqHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreqHeader::BhattackdsrOptionRreqHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::AddNodeAddress(ns3::Ipv4Address ipv4) [member function]
    cls.add_method('AddNodeAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'ipv4')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetNodesAddresses() const [member function]
    cls.add_method('GetNodesAddresses', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetNodesNumber() const [member function]
    cls.add_method('GetNodesNumber', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetTarget() [member function]
    cls.add_method('GetTarget', 
                   'ns3::Ipv4Address', 
                   [])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::SetId(uint16_t identification) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionRreqHeader::SetTarget(ns3::Ipv4Address target) [member function]
    cls.add_method('SetTarget', 
                   'void', 
                   [param('ns3::Ipv4Address', 'target')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionSRHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSRHeader::BhattackdsrOptionSRHeader(ns3::bhattackdsr::BhattackdsrOptionSRHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionSRHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSRHeader::BhattackdsrOptionSRHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionSRHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetNodeListSize() const [member function]
    cls.add_method('GetNodeListSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetSegmentsLeft() const [member function]
    cls.add_method('GetSegmentsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionSRHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionSRHeader::SetSegmentsLeft(uint8_t segmentsLeft) [member function]
    cls.add_method('SetSegmentsLeft', 
                   'void', 
                   [param('uint8_t', 'segmentsLeft')])
    return

def register_Ns3BhattackdsrBhattackdsrOptions_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptions::BhattackdsrOptions(ns3::bhattackdsr::BhattackdsrOptions const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptions const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptions::BhattackdsrOptions() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrOptions::CheckDuplicates(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('CheckDuplicates', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrOptions::ContainAddressAfter(ns3::Ipv4Address ipv4Address, ns3::Ipv4Address destAddress, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    ...
    ## bhattackdsr-options.h (module 'bhattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::bhattackdsr::BhattackdsrOptions::CutRoute(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    cls.add_method('CutRoute', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'nodeList')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptions::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ptr<ns3::Node> ns3::bhattackdsr::BhattackdsrOptions::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ptr<ns3::Node> ns3::bhattackdsr::BhattackdsrOptions::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptions::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptions::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrOptions::IfDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec2) [member function]
    cls.add_method('IfDuplicates', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec'), param('std::vector< ns3::Ipv4Address > &', 'vec2')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptions::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptions::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_pure_virtual=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptions::RemoveDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('RemoveDuplicates', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrOptions::ReverseRoutes(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseRoutes', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptions::ReverseSearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptions::ReverseSearchNextTwoHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextTwoHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptions::ScheduleReply(ns3::Ptr<ns3::Packet> & packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, ns3::Ipv4Address & source, ns3::Ipv4Address & destination) [member function]
    ...
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptions::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptions::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::bhattackdsr::BhattackdsrOptions::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
...
def register_Ns3BhattackdsrBhattackdsrPassiveBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::BhattackdsrPassiveBuffEntry(ns3::bhattackdsr::BhattackdsrPassiveBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrPassiveBuffEntry const &', 'arg0')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::BhattackdsrPassiveBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), uint16_t i=0, uint16_t f=0, uint8_t seg=0, ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetFragmentOffset() const [member function]
    cls.add_method('GetFragmentOffset', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Ptr<const ns3::Packet> ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetFragmentOffset(uint16_t f) [member function]
    cls.add_method('SetFragmentOffset', 
                   'void', 
                   [param('uint16_t', 'f')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetSegsLeft(uint8_t seg) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'seg')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3BhattackdsrBhattackdsrPassiveBuffer_methods(root_module, cls):
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffer::BhattackdsrPassiveBuffer(ns3::bhattackdsr::BhattackdsrPassiveBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrPassiveBuffer const &', 'arg0')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrPassiveBuffer::BhattackdsrPassiveBuffer() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrPassiveBuffer::AllEqual(ns3::bhattackdsr::BhattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrPassiveBuffEntry &', 'entry')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrPassiveBuffer::Dequeue(ns3::Ipv4Address dst, ns3::bhattackdsr::BhattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::bhattackdsr::BhattackdsrPassiveBuffEntry &', 'entry')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrPassiveBuffer::Enqueue(ns3::bhattackdsr::BhattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrPassiveBuffEntry &', 'entry')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrPassiveBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrPassiveBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrPassiveBuffer::GetPassiveBufferTimeout() const [member function]
    cls.add_method('GetPassiveBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrPassiveBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrPassiveBuffer::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## bhattackdsr-passive-buff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrPassiveBuffer::SetPassiveBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetPassiveBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3BhattackdsrBhattackdsrReceivedRreqEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::BhattackdsrReceivedRreqEntry(ns3::bhattackdsr::BhattackdsrReceivedRreqEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrReceivedRreqEntry const &', 'arg0')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::BhattackdsrReceivedRreqEntry(ns3::Ipv4Address d=ns3::Ipv4Address(), uint16_t i=0) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'd', default_value='ns3::Ipv4Address()'), param('uint16_t', 'i', default_value='0')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrReceivedRreqEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3BhattackdsrBhattackdsrRouteCache_methods(root_module, cls):
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::BhattackdsrRouteCache(ns3::bhattackdsr::BhattackdsrRouteCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRouteCache const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::BhattackdsrRouteCache() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::AddArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::AddNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Ipv4Address ownAddress, ns3::Time expire) [member function]
    ...
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::AddRoute(ns3::bhattackdsr::BhattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry &', 'rt')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::AddRoute_Link(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address node) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'node')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrRouteCache::CheckUniqueAckId(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('CheckUniqueAckId', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::ClearMac() [member function]
    cls.add_method('ClearMac', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::DelArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    ...
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::FindSameRoute(ns3::bhattackdsr::BhattackdsrRouteCacheEntry & rt, std::list<ns3::bhattackdsr::BhattackdsrRouteCacheEntry, std::allocator<ns3::bhattackdsr::BhattackdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('FindSameRoute', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry &', 'rt'), param('std::list< ns3::bhattackdsr::BhattackdsrRouteCacheEntry > &', 'rtVector')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrRouteCache::GetAckSize() [member function]
    cls.add_method('GetAckSize', 
                   'uint16_t', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetCacheTimeout() const [member function]
    cls.add_method('GetCacheTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::bhattackdsr::BhattackdsrRouteCache::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetInitStability() const [member function]
    cls.add_method('GetInitStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRouteCache::GetMaxCacheLen() const [member function]
    cls.add_method('GetMaxCacheLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRouteCache::GetMaxEntriesEachDst() const [member function]
    cls.add_method('GetMaxEntriesEachDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetMinLifeTime() const [member function]
    cls.add_method('GetMinLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint64_t ns3::bhattackdsr::BhattackdsrRouteCache::GetStabilityDecrFactor() const [member function]
    cls.add_method('GetStabilityDecrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): uint64_t ns3::bhattackdsr::BhattackdsrRouteCache::GetStabilityIncrFactor() const [member function]
    cls.add_method('GetStabilityIncrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::GetSubRoute() const [member function]
    cls.add_method('GetSubRoute', 
                   'bool', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::bhattackdsr::BhattackdsrRouteCache::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrRouteCache::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCache::GetUseExtends() const [member function]
    cls.add_method('GetUseExtends', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Mac48Address ns3::bhattackdsr::BhattackdsrRouteCache::LookupMacAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('LookupMacAddress', 
                   'ns3::Mac48Address', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::LookupRoute(ns3::Ipv4Address id, ns3::bhattackdsr::BhattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry &', 'rt')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::Print(std::ostream & os) [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::PrintRouteVector(std::list<ns3::bhattackdsr::BhattackdsrRouteCacheEntry, std::allocator<ns3::bhattackdsr::BhattackdsrRouteCacheEntry> > route) [member function]
    cls.add_method('PrintRouteVector', 
                   'void', 
                   [param('std::list< ns3::bhattackdsr::BhattackdsrRouteCacheEntry >', 'route')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::ProcessTxError(ns3::WifiMacHeader const & hdr) [member function]
    cls.add_method('ProcessTxError', 
                   'void', 
                   [param('ns3::WifiMacHeader const &', 'hdr')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::PurgeLinkNode() [member function]
    cls.add_method('PurgeLinkNode', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::PurgeMac() [member function]
    cls.add_method('PurgeMac', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::RebuildBestRouteTable(ns3::Ipv4Address source) [member function]
    cls.add_method('RebuildBestRouteTable', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::RemoveLastEntry(std::list<ns3::bhattackdsr::BhattackdsrRouteCacheEntry, std::allocator<ns3::bhattackdsr::BhattackdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('RemoveLastEntry', 
                   'void', 
                   [param('std::list< ns3::bhattackdsr::BhattackdsrRouteCacheEntry > &', 'rtVector')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetCacheTimeout(ns3::Time t) [member function]
    cls.add_method('SetCacheTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetCacheType(std::string type) [member function]
    cls.add_method('SetCacheType', 
                   'void', 
                   [param('std::string', 'type')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetCallback(ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetInitStability(ns3::Time initStability) [member function]
    cls.add_method('SetInitStability', 
                   'void', 
                   [param('ns3::Time', 'initStability')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetMaxCacheLen(uint32_t len) [member function]
    cls.add_method('SetMaxCacheLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetMaxEntriesEachDst(uint32_t entries) [member function]
    cls.add_method('SetMaxEntriesEachDst', 
                   'void', 
                   [param('uint32_t', 'entries')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetMinLifeTime(ns3::Time minLifeTime) [member function]
    cls.add_method('SetMinLifeTime', 
                   'void', 
                   [param('ns3::Time', 'minLifeTime')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetStabilityDecrFactor(uint64_t decrFactor) [member function]
    cls.add_method('SetStabilityDecrFactor', 
                   'void', 
                   [param('uint64_t', 'decrFactor')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetStabilityIncrFactor(uint64_t incrFactor) [member function]
    cls.add_method('SetStabilityIncrFactor', 
                   'void', 
                   [param('uint64_t', 'incrFactor')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetSubRoute(bool subRoute) [member function]
    cls.add_method('SetSubRoute', 
                   'void', 
                   [param('bool', 'subRoute')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::SetUseExtends(ns3::Time useExtends) [member function]
    cls.add_method('SetUseExtends', 
                   'void', 
                   [param('ns3::Time', 'useExtends')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::UpdateNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Time expire) [member function]
    cls.add_method('UpdateNeighbor', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodeList'), param('ns3::Time', 'expire')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::UpdateNetGraph() [member function]
    cls.add_method('UpdateNetGraph', 
                   'void', 
                   [])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCache::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCache::UseExtends(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_arp [variable]
    cls.add_instance_attribute('m_arp', 'std::vector< ns3::Ptr< ns3::ArpCache > >', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_delay [variable]
    cls.add_instance_attribute('m_delay', 'ns3::Time', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_handleLinkFailure [variable]
    ...
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_nb [variable]
    cls.add_instance_attribute('m_nb', 'std::vector< ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor >', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_ntimer [variable]
    cls.add_instance_attribute('m_ntimer', 'ns3::Timer', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::m_txErrorCallback [variable]
...
def register_Ns3BhattackdsrBhattackdsrRouteCacheNeighbor_methods(root_module, cls):
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::Neighbor(ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::Neighbor() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCache::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrBhattackdsrRouteCacheEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCacheEntry::BhattackdsrRouteCacheEntry(ns3::bhattackdsr::BhattackdsrRouteCacheEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCacheEntry::BhattackdsrRouteCacheEntry(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR const & ip=::ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR( ), ns3::Ipv4Address dst=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR const &', 'ip', default_value='::ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR( )'), param('ns3::Ipv4Address', 'dst', default_value='ns3::Ipv4Address()'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCacheEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrRouteCacheEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrRouteCacheEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR ns3::bhattackdsr::BhattackdsrRouteCacheEntry::GetVector() const [member function]
    cls.add_method('GetVector', 
                   'ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouteCacheEntry::SetVector(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR v) [member function]
    cls.add_method('SetVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'v')])
    return

def register_Ns3BhattackdsrBhattackdsrRouting_methods(root_module, cls):
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouting::BhattackdsrRouting(ns3::bhattackdsr::BhattackdsrRouting const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRouting const &', 'arg0')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouting::BhattackdsrRouting() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrRouting::AddAckReqHeader(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('AddAckReqHeader', 
                   'uint16_t', 
                   [param('ns3::Ptr< ns3::Packet > &', 'packet'), param('ns3::Ipv4Address', 'nextHop')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::AddRoute(ns3::bhattackdsr::BhattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry &', 'rt')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::AddRoute_Link(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address source) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'source')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): int64_t ns3::bhattackdsr::BhattackdsrRouting::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CallCancelPacketTimer(uint16_t ackId, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelLinkPacketTimer(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelLinkPacketTimer', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelNetworkPacketTimer(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelNetworkPacketTimer', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelPacketAllTimer(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPacketAllTimer', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelPacketTimerNextHop(ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('CancelPacketTimerNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelPassivePacketTimer(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPassivePacketTimer', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::CancelPassiveTimer(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CancelRreqTimer(ns3::Ipv4Address dst, bool isRemove) [member function]
    cls.add_method('CancelRreqTimer', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst'), param('bool', 'isRemove')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::CheckSendBuffer() [member function]
    cls.add_method('CheckSendBuffer', 
                   'void', 
                   [])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    cls.add_method('DeleteAllRoutesIncludeLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrc'), param('ns3::Ipv4Address', 'unreachNode'), param('ns3::Ipv4Address', 'node')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ForwardErrPacket(ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader & rerr, ns3::bhattackdsr::BhattackdsrOptionSRHeader & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardErrPacket', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader &', 'rerr'), param('ns3::bhattackdsr::BhattackdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ForwardPacket(ns3::Ptr<const ns3::Packet> packet, ns3::bhattackdsr::BhattackdsrOptionSRHeader & sourceRoute, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ipv4Address targetAddress, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::bhattackdsr::BhattackdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('ns3::Ipv4Address', 'targetAddress'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::IpL4Protocol::DownTargetCallback ns3::bhattackdsr::BhattackdsrRouting::GetDownTarget() const [member function]
    cls.add_method('GetDownTarget', 
                   'ns3::IpL4Protocol::DownTargetCallback', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::IpL4Protocol::DownTargetCallback6 ns3::bhattackdsr::BhattackdsrRouting::GetDownTarget6() const [member function]
    cls.add_method('GetDownTarget6', 
                   'ns3::IpL4Protocol::DownTargetCallback6', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): std::vector<std::basic_string<char>, std::allocator<std::basic_string<char> > > ns3::bhattackdsr::BhattackdsrRouting::GetElementsFromContext(std::string context) [member function]
    cls.add_method('GetElementsFromContext', 
                   'std::vector< std::string >', 
                   [param('std::string', 'context')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrRouting::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrRouting::GetIPfromID(uint16_t id) [member function]
    cls.add_method('GetIPfromID', 
                   'ns3::Ipv4Address', 
                   [param('uint16_t', 'id')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrRouting::GetIPfromMAC(ns3::Mac48Address address) [member function]
    cls.add_method('GetIPfromMAC', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Mac48Address', 'address')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::NetDevice> ns3::bhattackdsr::BhattackdsrRouting::GetNetDeviceFromContext(std::string context) [member function]
    cls.add_method('GetNetDeviceFromContext', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('std::string', 'context')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::Node> ns3::bhattackdsr::BhattackdsrRouting::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::Node> ns3::bhattackdsr::BhattackdsrRouting::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::bhattackdsr::BhattackdsrOptions> ns3::bhattackdsr::BhattackdsrRouting::GetOption(int optionNumber) [member function]
    cls.add_method('GetOption', 
                   'ns3::Ptr< ns3::bhattackdsr::BhattackdsrOptions >', 
                   [param('int', 'optionNumber')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::bhattackdsr::BhattackdsrPassiveBuffer> ns3::bhattackdsr::BhattackdsrRouting::GetPassiveBuffer() const [member function]
    cls.add_method('GetPassiveBuffer', 
                   'ns3::Ptr< ns3::bhattackdsr::BhattackdsrPassiveBuffer >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRouting::GetPriority(ns3::bhattackdsr::BhattackdsrMessageType messageType) [member function]
    cls.add_method('GetPriority', 
                   'uint32_t', 
                   [param('ns3::bhattackdsr::BhattackdsrMessageType', 'messageType')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): int ns3::bhattackdsr::BhattackdsrRouting::GetProtocolNumber() const [member function]
    cls.add_method('GetProtocolNumber', 
                   'int', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::bhattackdsr::BhattackdsrRreqTable> ns3::bhattackdsr::BhattackdsrRouting::GetRequestTable() const [member function]
    cls.add_method('GetRequestTable', 
                   'ns3::Ptr< ns3::bhattackdsr::BhattackdsrRreqTable >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::bhattackdsr::BhattackdsrRouteCache> ns3::bhattackdsr::BhattackdsrRouting::GetRouteCache() const [member function]
    cls.add_method('GetRouteCache', 
                   'ns3::Ptr< ns3::bhattackdsr::BhattackdsrRouteCache >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrRouting::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::IncreaseRetransTimer() [member function]
    cls.add_method('IncreaseRetransTimer', 
                   'void', 
                   [])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::Insert(ns3::Ptr<ns3::bhattackdsr::BhattackdsrOptions> option) [member function]
    cls.add_method('Insert', 
                   'void', 
                   [param('ns3::Ptr< ns3::bhattackdsr::BhattackdsrOptions >', 'option')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::LinkScheduleTimerExpire(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('LinkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::LookupRoute(ns3::Ipv4Address id, ns3::bhattackdsr::BhattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::bhattackdsr::BhattackdsrRouteCacheEntry &', 'rt')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::NetworkScheduleTimerExpire(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('NetworkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::PacketNewRoute(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::PassiveEntryCheck(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft, uint16_t fragmentOffset, uint16_t identification, bool saveEntry) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::PassiveScheduleTimerExpire(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('PassiveScheduleTimerExpire', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::PriorityScheduler(uint32_t priority, bool continueWithFirst) [member function]
    cls.add_method('PriorityScheduler', 
                   'void', 
                   [param('uint32_t', 'priority'), param('bool', 'continueWithFirst')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrRouting::Process(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address dst, uint8_t * nextHeader, uint8_t protocol, bool & isDropped) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::IpL4Protocol::RxStatus ns3::bhattackdsr::BhattackdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::Ipv4Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::Ipv4Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::IpL4Protocol::RxStatus ns3::bhattackdsr::BhattackdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv6Header const & header, ns3::Ptr<ns3::Ipv6Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv6Header const &', 'header'), param('ns3::Ptr< ns3::Ipv6Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::RouteRequestTimerExpire(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SalvagePacket(ns3::Ptr<const ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address dst, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleCachedReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ptr<ns3::Ipv4Route> route, double hops) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleInitialReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleInterRequest(ns3::Ptr<ns3::Packet> packet) [member function]
    cls.add_method('ScheduleInterRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleLinkPacketRetry(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('ScheduleLinkPacketRetry', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleNetworkPacketRetry(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, bool isFirst, uint8_t protocol) [member function]
    cls.add_method('ScheduleNetworkPacketRetry', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('bool', 'isFirst'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SchedulePassivePacketRetry(ns3::bhattackdsr::BhattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('SchedulePassivePacketRetry', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::ScheduleRreqRetry(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, bool nonProp, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::Scheduler(uint32_t priority) [member function]
    cls.add_method('Scheduler', 
                   'void', 
                   [param('uint32_t', 'priority')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrRouting::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::Send(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('Send', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendAck(uint16_t ackId, ns3::Ipv4Address destination, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendBuffTimerExpire() [member function]
    cls.add_method('SendBuffTimerExpire', 
                   'void', 
                   [])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendErrorRequest(ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader & rerr, uint8_t protocol) [member function]
    cls.add_method('SendErrorRequest', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader &', 'rerr'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendGratuitousReply(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendInitialRequest(ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    cls.add_method('SendInitialRequest', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendPacket(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendPacketFromBuffer(ns3::bhattackdsr::BhattackdsrOptionSRHeader const & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacketFromBuffer', 
                   'void', 
                   [param('ns3::bhattackdsr::BhattackdsrOptionSRHeader const &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::SendRealDown(ns3::bhattackdsr::BhattackdsrNetworkQueueEntry & newEntry) [member function]
    cls.add_method('SendRealDown', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrNetworkQueueEntry &', 'newEntry')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SendReply', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendRequest(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source) [member function]
    cls.add_method('SendRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SendUnreachError(ns3::Ipv4Address unreachNode, ns3::Ipv4Address destination, ns3::Ipv4Address originalDst, uint8_t salvage, uint8_t protocol) [member function]
    ...
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetDownTarget(ns3::IpL4Protocol::DownTargetCallback callback) [member function]
    cls.add_method('SetDownTarget', 
                   'void', 
                   ...
                   is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetDownTarget6(ns3::IpL4Protocol::DownTargetCallback6 callback) [member function]
    cls.add_method('SetDownTarget6', 
                   'void', 
                   ...
                   is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetPassiveBuffer(ns3::Ptr<ns3::bhattackdsr::BhattackdsrPassiveBuffer> r) [member function]
    cls.add_method('SetPassiveBuffer', 
                   'void', 
                   [param('ns3::Ptr< ns3::bhattackdsr::BhattackdsrPassiveBuffer >', 'r')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetRequestTable(ns3::Ptr<ns3::bhattackdsr::BhattackdsrRreqTable> r) [member function]
    cls.add_method('SetRequestTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::bhattackdsr::BhattackdsrRreqTable >', 'r')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::bhattackdsr::BhattackdsrRouting::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
    cls.add_method('SetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ipv4Address', 'srcAddress')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::SetRouteCache(ns3::Ptr<ns3::bhattackdsr::BhattackdsrRouteCache> r) [member function]
    cls.add_method('SetRouteCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::bhattackdsr::BhattackdsrRouteCache >', 'r')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRouting::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::UseExtends(ns3::bhattackdsr::BhattackdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## bhattackdsr-routing.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRouting::PROT_NUMBER [variable]
    cls.add_static_attribute('PROT_NUMBER', 'uint8_t const', is_const=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## bhattackdsr-routing.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRouting::NotifyNewAggregate() [member function]
    cls.add_method('NotifyNewAggregate', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3BhattackdsrBhattackdsrRoutingHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRoutingHeader::BhattackdsrRoutingHeader(ns3::bhattackdsr::BhattackdsrRoutingHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRoutingHeader const &', 'arg0')])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRoutingHeader::BhattackdsrRoutingHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRoutingHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrRoutingHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRoutingHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrRoutingHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRoutingHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-fs-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRoutingHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3BhattackdsrBhattackdsrRreqTable_methods(root_module, cls):
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRreqTable::BhattackdsrRreqTable(ns3::bhattackdsr::BhattackdsrRreqTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrRreqTable const &', 'arg0')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrRreqTable::BhattackdsrRreqTable() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::CheckUniqueRreqId(ns3::Ipv4Address dst) [member function]
    cls.add_method('CheckUniqueRreqId', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::FindAndUpdate(ns3::Ipv4Address dst) [member function]
    cls.add_method('FindAndUpdate', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRreqTable::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::BlackList * ns3::bhattackdsr::BhattackdsrRreqTable::FindUnidirectional(ns3::Ipv4Address neighbor) [member function]
    cls.add_method('FindUnidirectional', 
                   'ns3::bhattackdsr::BlackList *', 
                   [param('ns3::Ipv4Address', 'neighbor')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetInitHopLimit() const [member function]
    cls.add_method('GetInitHopLimit', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetRreqCnt(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetRreqCnt', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetRreqIdSize() const [member function]
    cls.add_method('GetRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetRreqSize() [member function]
    cls.add_method('GetRreqSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetRreqTableSize() const [member function]
    cls.add_method('GetRreqTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrRreqTable::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrRreqTable::GetUniqueRreqIdSize() const [member function]
    cls.add_method('GetUniqueRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::Invalidate() [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrRreqTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::PurgeNeighbor() [member function]
    cls.add_method('PurgeNeighbor', 
                   'void', 
                   [])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::RemoveLeastExpire() [member function]
    cls.add_method('RemoveLeastExpire', 
                   'void', 
                   [])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::RemoveRreqEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('RemoveRreqEntry', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::SetInitHopLimit(uint32_t hl) [member function]
    cls.add_method('SetInitHopLimit', 
                   'void', 
                   [param('uint32_t', 'hl')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::SetRreqIdSize(uint32_t id) [member function]
    cls.add_method('SetRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::SetRreqTableSize(uint32_t rt) [member function]
    cls.add_method('SetRreqTableSize', 
                   'void', 
                   [param('uint32_t', 'rt')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrRreqTable::SetUniqueRreqIdSize(uint32_t uid) [member function]
    cls.add_method('SetUniqueRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'uid')])
    return

def register_Ns3BhattackdsrBhattackdsrSendBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffEntry::BhattackdsrSendBuffEntry(ns3::bhattackdsr::BhattackdsrSendBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrSendBuffEntry const &', 'arg0')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffEntry::BhattackdsrSendBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrSendBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrSendBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::Ptr<const ns3::Packet> ns3::bhattackdsr::BhattackdsrSendBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrSendBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    return

def register_Ns3BhattackdsrBhattackdsrSendBuffer_methods(root_module, cls):
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffer::BhattackdsrSendBuffer(ns3::bhattackdsr::BhattackdsrSendBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrSendBuffer const &', 'arg0')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrSendBuffer::BhattackdsrSendBuffer() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrSendBuffer::Dequeue(ns3::Ipv4Address dst, ns3::bhattackdsr::BhattackdsrSendBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::bhattackdsr::BhattackdsrSendBuffEntry &', 'entry')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffer::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrSendBuffer::Enqueue(ns3::bhattackdsr::BhattackdsrSendBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::bhattackdsr::BhattackdsrSendBuffEntry &', 'entry')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): bool ns3::bhattackdsr::BhattackdsrSendBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): std::vector<ns3::bhattackdsr::BhattackdsrSendBuffEntry, std::allocator<ns3::bhattackdsr::BhattackdsrSendBuffEntry> > & ns3::bhattackdsr::BhattackdsrSendBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::bhattackdsr::BhattackdsrSendBuffEntry > &', 
                   [])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrSendBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): ns3::Time ns3::bhattackdsr::BhattackdsrSendBuffer::GetSendBufferTimeout() const [member function]
    cls.add_method('GetSendBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrSendBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## bhattackdsr-rsendbuff.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrSendBuffer::SetSendBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetSendBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3BhattackdsrGraReplyEntry_methods(root_module, cls):
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry::GraReplyEntry(ns3::bhattackdsr::GraReplyEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::GraReplyEntry const &', 'arg0')])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry::GraReplyEntry(ns3::Ipv4Address t, ns3::Ipv4Address f, ns3::Time h) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 't'), param('ns3::Ipv4Address', 'f'), param('ns3::Time', 'h')])
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry::m_gratReplyHoldoff [variable]
    cls.add_instance_attribute('m_gratReplyHoldoff', 'ns3::Time', is_const=False)
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry::m_hearFrom [variable]
    cls.add_instance_attribute('m_hearFrom', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-gratuitous-reply-table.h (module 'bhattackdsr'): ns3::bhattackdsr::GraReplyEntry::m_replyTo [variable]
    cls.add_instance_attribute('m_replyTo', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrLink_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::Link::Link(ns3::bhattackdsr::Link const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::Link const &', 'arg0')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::Link::Link(ns3::Ipv4Address ip1, ns3::Ipv4Address ip2) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip1'), param('ns3::Ipv4Address', 'ip2')])
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): void ns3::bhattackdsr::Link::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::Link::m_high [variable]
    cls.add_instance_attribute('m_high', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-rcache.h (module 'bhattackdsr'): ns3::bhattackdsr::Link::m_low [variable]
    cls.add_instance_attribute('m_low', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrLinkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::LinkKey() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::LinkKey(ns3::bhattackdsr::LinkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::LinkKey const &', 'arg0')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::LinkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrNetworkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::NetworkKey() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::NetworkKey(ns3::bhattackdsr::NetworkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::NetworkKey const &', 'arg0')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::NetworkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrPassiveKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::PassiveKey() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::PassiveKey(ns3::bhattackdsr::PassiveKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::PassiveKey const &', 'arg0')])
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::m_segsLeft [variable]
    cls.add_instance_attribute('m_segsLeft', 'uint8_t', is_const=False)
    ## bhattackdsr-maintain-buff.h (module 'bhattackdsr'): ns3::bhattackdsr::PassiveKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3BhattackdsrRreqTableEntry_methods(root_module, cls):
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::RreqTableEntry::RreqTableEntry() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::RreqTableEntry::RreqTableEntry(ns3::bhattackdsr::RreqTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::RreqTableEntry const &', 'arg0')])
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::RreqTableEntry::m_expire [variable]
    cls.add_instance_attribute('m_expire', 'ns3::Time', is_const=False)
    ## bhattackdsr-rreq-table.h (module 'bhattackdsr'): ns3::bhattackdsr::RreqTableEntry::m_reqNo [variable]
    cls.add_instance_attribute('m_reqNo', 'uint32_t', is_const=False)
    return

def register_Ns3BhattackdsrBhattackdsrOptionAck_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAck::BhattackdsrOptionAck(ns3::bhattackdsr::BhattackdsrOptionAck const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionAck const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAck::BhattackdsrOptionAck() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAck::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionAck::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAck::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionAck::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAck::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionAckHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckHeader::BhattackdsrOptionAckHeader(ns3::bhattackdsr::BhattackdsrOptionAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionAckHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckHeader::BhattackdsrOptionAckHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetRealDst() const [member function]
    cls.add_method('GetRealDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::Ipv4Address ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetRealSrc() const [member function]
    cls.add_method('GetRealSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckHeader::SetRealDst(ns3::Ipv4Address realDstAddress) [member function]
    cls.add_method('SetRealDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realDstAddress')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckHeader::SetRealSrc(ns3::Ipv4Address realSrcAddress) [member function]
    cls.add_method('SetRealSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realSrcAddress')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionAckReq_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReq::BhattackdsrOptionAckReq(ns3::bhattackdsr::BhattackdsrOptionAckReq const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionAckReq const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReq::BhattackdsrOptionAckReq() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckReq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionAckReq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckReq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionAckReq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionAckReqHeader_methods(root_module, cls):
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::BhattackdsrOptionAckReqHeader(ns3::bhattackdsr::BhattackdsrOptionAckReqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionAckReqHeader const &', 'arg0')])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::BhattackdsrOptionAckReqHeader() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint16_t ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::bhattackdsr::BhattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): uint32_t ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-option-header.h (module 'bhattackdsr'): void ns3::bhattackdsr::BhattackdsrOptionAckReqHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    return

def register_Ns3BhattackdsrBhattackdsrOptionPad1_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1::BhattackdsrOptionPad1(ns3::bhattackdsr::BhattackdsrOptionPad1 const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionPad1 const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1::BhattackdsrOptionPad1() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionPad1::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPad1::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionPad1::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPad1::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionPadn_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadn::BhattackdsrOptionPadn(ns3::bhattackdsr::BhattackdsrOptionPadn const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionPadn const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadn::BhattackdsrOptionPadn() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionPadn::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionPadn::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionPadn::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionPadn::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionRerr_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerr::BhattackdsrOptionRerr(ns3::bhattackdsr::BhattackdsrOptionRerr const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRerr const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerr::BhattackdsrOptionRerr() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerr::DoSendError(ns3::Ptr<ns3::Packet> p, ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader & rerr, uint32_t rerrSize, ns3::Ipv4Address ipv4Address, uint8_t protocol) [member function]
    cls.add_method('DoSendError', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::bhattackdsr::BhattackdsrOptionRerrUnreachHeader &', 'rerr'), param('uint32_t', 'rerrSize'), param('ns3::Ipv4Address', 'ipv4Address'), param('uint8_t', 'protocol')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerr::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerr::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRerr::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRerr::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRerr::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionRrep_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrep::BhattackdsrOptionRrep(ns3::bhattackdsr::BhattackdsrOptionRrep const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRrep const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrep::BhattackdsrOptionRrep() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRrep::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRrep::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRrep::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRrep::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRrep::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionRreq_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreq::BhattackdsrOptionRreq(ns3::bhattackdsr::BhattackdsrOptionRreq const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionRreq const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreq::BhattackdsrOptionRreq() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRreq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRreq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionRreq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionRreq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionRreq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3BhattackdsrBhattackdsrOptionSR_methods(root_module, cls):
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSR::BhattackdsrOptionSR(ns3::bhattackdsr::BhattackdsrOptionSR const & arg0) [constructor]
    cls.add_constructor([param('ns3::bhattackdsr::BhattackdsrOptionSR const &', 'arg0')])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSR::BhattackdsrOptionSR() [constructor]
    cls.add_constructor([])
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionSR::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionSR::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): static ns3::TypeId ns3::bhattackdsr::BhattackdsrOptionSR::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): uint8_t ns3::bhattackdsr::BhattackdsrOptionSR::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> bhattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'bhattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## bhattackdsr-options.h (module 'bhattackdsr'): ns3::bhattackdsr::BhattackdsrOptionSR::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return
...
def register_functions(root_module):
    ...
    register_functions_ns3_bhattackdsr(module.add_cpp_namespace('bhattackdsr'), root_module)
...
def register_functions_ns3_bhattackdsr(module, root_module):
    return
