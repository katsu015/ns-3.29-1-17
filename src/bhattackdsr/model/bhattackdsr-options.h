...
class BhattackdsrOptions : public Object
{
public:
  /**
   ...
   *
   * Called from BhattackdsrRouting::Receive.
   * \param packet the packet
   * \param bhattackdsrP  the clean packet with payload
   ...
   */
  virtual uint8_t Process (Ptr<Packet> packet, Ptr<Packet> bhattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource) = 0;
...
protected:
   ...
   */
  Ptr<bhattackdsr::BhattackdsrRreqTable> m_rreqTable;
  /**
   * \brief The route cache table.
   */
  Ptr<bhattackdsr::BhattackdsrRouteCache> m_routeCache;
  /**
   ...
   */
  TracedCallback <const BhattackdsrOptionSRHeader &> m_rxPacketTrace;
...
/**
 * \class BhattackdsrOptionPad1
 * \brief Bhattackdsr Option Pad1
 */
class BhattackdsrOptionPad1 : public BhattackdsrOptions
{
public:
  /**
  ...
  BhattackdsrOptionPad1 ();
  virtual ~BhattackdsrOptionPad1 ();

  virtual uint8_t GetOptionNumber () const;
  virtual uint8_t Process (Ptr<Packet> packet, Ptr<Packet> bhattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource);
};

/**
 * \class BhattackdsrOptionPadn
 * \brief IPv4 Option Padn
 */
class BhattackdsrOptionPadn : public BhattackdsrOptions
{
public:
  /**
  ...
  BhattackdsrOptionPadn ();
  virtual ~BhattackdsrOptionPadn ();
...
/**
 * \class BhattackdsrOptionRreq
 * \brief Bhattackdsr Option Rreq
 */
class BhattackdsrOptionRreq : public BhattackdsrOptions
{
public:
  /**
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRreq ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRreq ();
...
/**
 * \class BhattackdsrOptionRrep
 * \brief Bhattackdsr Option Route Reply
 */
class BhattackdsrOptionRrep : public BhattackdsrOptions
{
public:
  /**
  ...
  BhattackdsrOptionRrep ();
  virtual ~BhattackdsrOptionRrep ();
...
/**
 * \class BhattackdsrOptionSR
 * \brief Bhattackdsr Option Source Route
 */
class BhattackdsrOptionSR : public BhattackdsrOptions
{
public:
  /**
...
/**
 * \class BhattackdsrOptionRerr
 * \brief Bhattackdsr Option Route Error
 */
class BhattackdsrOptionRerr : public BhattackdsrOptions
{
public:
  /**
   * \brief Bhattackdsr Route Error option number.
   */
  ...
  BhattackdsrOptionRerr ();
  virtual ~BhattackdsrOptionRerr ();
   ...
   *
   * \param p the packet
   * \param rerr  the BhattackdsrOptionRerrUnreachHeader header
   * \param rerrSize the route error header size
   * \param ipv4Address ipv4 address of our own
   * \param protocol the protocol number of the up layer
   * \return the processed size
   */
  uint8_t DoSendError (Ptr<Packet> p, BhattackdsrOptionRerrUnreachHeader &rerr, uint32_t rerrSize, Ipv4Address ipv4Address, uint8_t protocol);
...
/**
 * \class BhattackdsrOptionAckReq
 * \brief Bhattackdsr Option
 */
class BhattackdsrOptionAckReq : public BhattackdsrOptions
{
public:
  /**
   * \brief Bhattackdsr ack request option number.
   */
  ...
  BhattackdsrOptionAckReq ();
  virtual ~BhattackdsrOptionAckReq ();
...
/**
 * \class BhattackdsrOptionAck
 * \brief Bhattackdsr Option Ack
 */
class BhattackdsrOptionAck : public BhattackdsrOptions
{
public:
  /**
   * \brief The Bhattackdsr Ack option number.
   */
  ...
  BhattackdsrOptionAck ();
  virtual ~BhattackdsrOptionAck ();
