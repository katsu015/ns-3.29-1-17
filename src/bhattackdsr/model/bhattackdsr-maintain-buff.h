 ...
 */
class BhattackdsrMaintainBuffEntry
{
public:
  /**
   * Construct a BhattackdsrMaintainBuffEntry with the given parameters
   *
   * \param pa packet
   ...
   */
  BhattackdsrMaintainBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address us = Ipv4Address (),
...
public:
  ...
  bool AllEqual (BhattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for link ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool LinkEqual (BhattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for network ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool NetworkEqual (BhattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for promiscuous ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool PromiscEqual (BhattackdsrMaintainBuffEntry & entry);

private:
  /// The vector of maintain buffer entries
  std::vector<BhattackdsrMaintainBuffEntry> m_maintainBuffer;
  ...
  static bool IsEqual (BhattackdsrMaintainBuffEntry en, const Ipv4Address nextHop)
  {
