...
/**
 * \class BhattackdsrOptionHeader
 * \brief Header for Bhattackdsr Options.
 */
class BhattackdsrOptionHeader : public Header
{
public:
  /**
   * \struct Alignment
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionHeader ();
  /**
...
/**
 * \class BhattackdsrOptionPad1Header
 * \brief Header of Bhattackdsr Option Pad1
 */
class BhattackdsrOptionPad1Header : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionPad1Header ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionPad1Header ();
  /**
   * \brief Print some information about the packet.
   * \param os output stream
   * \return info about this packet
...
/**
 * \class BhattackdsrOptionPadnHeader
 * \brief Header of Bhattackdsr Option Padn
 */
class BhattackdsrOptionPadnHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   */
  BhattackdsrOptionPadnHeader (uint32_t pad = 2);
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionPadnHeader ();
  /**
   * \brief Print some information about the packet.
   * \param os output stream
   * \return info about this packet
...
/**
 * \class BhattackdsrOptionRouteRequestHeader
 * \brief Header of Bhattackdsr Option Route Request
 */
...
class BhattackdsrOptionRreqHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRreqHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRreqHeader ();
  /**
...
/**
 * \class BhattackdsrOptionRrepHeader
 * \brief Header of Bhattackdsr Option Route Reply
 */
...
class BhattackdsrOptionRrepHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRrepHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRrepHeader ();
  /**
   * \brief Set the number of ipv4 address.
   * \param n the number of ipv4 address
   */
...
/**
 * \class BhattackdsrOptionSRHeader
 * \brief Header of Bhattackdsr Option Source Route
 */
...
class BhattackdsrOptionSRHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionSRHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionSRHeader ();
  /**
  ...
  /**
   * TracedCallback signature for BhattackdsrOptionSrHeader.
   *
   * \param [in] header The BhattackdsrOptionsSRHeader
   */
  typedef void (*TracedCallback)(const BhattackdsrOptionSRHeader & header);
...
/**
 * \class BhattackdsrOptionRerrHeader
 * \brief Header of Bhattackdsr Option Route Error
 */
...
class BhattackdsrOptionRerrHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRerrHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRerrHeader ();
  /**
...
class BhattackdsrOptionRerrUnreachHeader : public BhattackdsrOptionRerrHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRerrUnreachHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRerrUnreachHeader ();
  /**
   * \brief Set the route error source address
   * \param errorSrcAddress The error source address
   */
...
class BhattackdsrOptionRerrUnsupportHeader : public BhattackdsrOptionRerrHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionRerrUnsupportHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionRerrUnsupportHeader ();
  /**
   * \brief Set the route error source address
   * \param errorSrcAddress The error source address
   */
...
/**
 * \class BhattackdsrOptionAckReqHeader
 * \brief Header of Bhattackdsr Option ack request
 */
...
class BhattackdsrOptionAckReqHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionAckReqHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionAckReqHeader ();
  /**
...
/**
 * \class BhattackdsrOptionAckHeader
 * \brief Header of Bhattackdsr Option ack
 */
...
class BhattackdsrOptionAckHeader : public BhattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  BhattackdsrOptionAckHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~BhattackdsrOptionAckHeader ();
  /**
...
static inline std::ostream & operator<< (std::ostream& os, const BhattackdsrOptionSRHeader & sr)
{
  sr.Print (os);
  return os;
}
