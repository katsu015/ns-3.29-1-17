...
NS_LOG_COMPONENT_DEFINE ("BhattackdsrMaintainBuffer");

namespace bhattackdsr {

uint32_t
BhattackdsrMaintainBuffer::GetSize ()
{
  Purge ();
...
bool
BhattackdsrMaintainBuffer::Enqueue (BhattackdsrMaintainBuffEntry & entry)
{
  Purge ();
  for (std::vector<BhattackdsrMaintainBuffEntry>::const_iterator i = m_maintainBuffer.begin (); i
...
void
BhattackdsrMaintainBuffer::DropPacketWithNextHop (Ipv4Address nextHop)
{
  ...
  m_maintainBuffer.erase (std::remove_if (m_maintainBuffer.begin (), m_maintainBuffer.end (),
                                          std::bind2nd (std::ptr_fun (BhattackdsrMaintainBuffer::IsEqual), nextHop)), m_maintainBuffer.end ());
}

bool
BhattackdsrMaintainBuffer::Dequeue (Ipv4Address nextHop, BhattackdsrMaintainBuffEntry & entry)
{
  Purge ();
  for (std::vector<BhattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i != m_maintainBuffer.end (); ++i)
    {
...
bool
BhattackdsrMaintainBuffer::Find (Ipv4Address nextHop)
{
  for (std::vector<BhattackdsrMaintainBuffEntry>::const_iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
BhattackdsrMaintainBuffer::AllEqual (BhattackdsrMaintainBuffEntry & entry)
{
  for (std::vector<BhattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
BhattackdsrMaintainBuffer::NetworkEqual (BhattackdsrMaintainBuffEntry & entry)
{
  for (std::vector<BhattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
BhattackdsrMaintainBuffer::PromiscEqual (BhattackdsrMaintainBuffEntry & entry)
{
...
bool
BhattackdsrMaintainBuffer::LinkEqual (BhattackdsrMaintainBuffEntry & entry)
{
  NS_LOG_DEBUG ("The maintenance buffer size " << m_maintainBuffer.size ());
  for (std::vector<BhattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
...
struct IsExpired
{
   ...
   */
  bool
  operator() (BhattackdsrMaintainBuffEntry const & e) const
  {
...
void
BhattackdsrMaintainBuffer::Purge ()
{
