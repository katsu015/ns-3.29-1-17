 ...
 */
class BhattackdsrErrorBuffEntry
{
public:
  /**
   * Create an BhattackdsrErrorBuffEntry with the given parameters.
   *
   * \param pa packet
   ...
   */
  BhattackdsrErrorBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (), Ipv4Address s = Ipv4Address (),
   ...
   * \param o another BhattackdsrErrorBuffEntry
   * \return true if equal
   */
  bool operator== (BhattackdsrErrorBuffEntry const & o) const
  {
 ...
 */
/************************************************************************************************************************/
class BhattackdsrErrorBuffer
{
public:
  /**
   * Default constructor
   */
  BhattackdsrErrorBuffer ()
  {
  }
  /**
   ...
   */
  bool Enqueue (BhattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  bool Dequeue (Ipv4Address dst, BhattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  std::vector<BhattackdsrErrorBuffEntry> & GetBuffer ()
  {
...
private:
  ...
  std::vector<BhattackdsrErrorBuffEntry> m_errorBuffer;
   ...
   */
  ///
  void Drop (BhattackdsrErrorBuffEntry en, std::string reason);
  /**
   * Notify that packet is dropped from queue by link error
   * \param en Error Buffer Entry
   * \param reason Drop reason.
   */
  void DropLink (BhattackdsrErrorBuffEntry en, std::string reason);
   ...
   */
  ///
  static bool LinkEqual (BhattackdsrErrorBuffEntry en, const std::vector<Ipv4Address> link)
  {
