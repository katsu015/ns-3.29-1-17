...
NS_LOG_COMPONENT_DEFINE ("BhattackdsrGraReplyTable");

namespace bhattackdsr {

NS_OBJECT_ENSURE_REGISTERED (BhattackdsrGraReply);

TypeId BhattackdsrGraReply::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::bhattackdsr::BhattackdsrGraReply")
    .SetParent<Object> ()
    .SetGroupName ("Bhattackdsr")
    .AddConstructor<BhattackdsrGraReply> ()
  ;
  return tid;
}

BhattackdsrGraReply::BhattackdsrGraReply ()
{
}
...
bool
BhattackdsrGraReply::FindAndUpdate (Ipv4Address replyTo, Ipv4Address replyFrom, Time gratReplyHoldoff)
{
...
bool
BhattackdsrGraReply::AddEntry (GraReplyEntry & graTableEntry)
{
