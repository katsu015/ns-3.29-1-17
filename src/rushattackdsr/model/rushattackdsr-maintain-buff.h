 ...
 */
class RushattackdsrMaintainBuffEntry
{
public:
  /**
   * Construct a RushattackdsrMaintainBuffEntry with the given parameters
   *
   * \param pa packet
   ...
   */
  RushattackdsrMaintainBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address us = Ipv4Address (),
 ...
 */
/************************************************************************************************************************/
class RushattackdsrMaintainBuffer
{
public:
  /**
   * Default constructor
   */
  RushattackdsrMaintainBuffer ()
  {
  }
  /// Push entry in queue, if there is no entry with the same packet and destination address in queue.
  /// \param entry Maintain Buffer Entry
  /// \return true on success adding the Entry.
  bool Enqueue (RushattackdsrMaintainBuffEntry & entry);
  /// Return first found (the earliest) entry for given destination
  /// \param [in] dst Entry destination
  /// \param [out] entry The Entry found (if any).
  /// \return true on success
  bool Dequeue (Ipv4Address dst, RushattackdsrMaintainBuffEntry & entry);
  ...
  bool AllEqual (RushattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for link ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool LinkEqual (RushattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for network ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool NetworkEqual (RushattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for promiscuous ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool PromiscEqual (RushattackdsrMaintainBuffEntry & entry);

private:
  /// The vector of maintain buffer entries
  std::vector<RushattackdsrMaintainBuffEntry> m_maintainBuffer;
  ...
  static bool IsEqual (RushattackdsrMaintainBuffEntry en, const Ipv4Address nextHop)
  {
