...
NS_LOG_COMPONENT_DEFINE ("RushattackdsrGraReplyTable");

namespace rushattackdsr {

NS_OBJECT_ENSURE_REGISTERED (RushattackdsrGraReply);

TypeId RushattackdsrGraReply::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrGraReply")
    .SetParent<Object> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrGraReply> ()
  ;
  return tid;
}

RushattackdsrGraReply::RushattackdsrGraReply ()
{
}
...
bool
RushattackdsrGraReply::FindAndUpdate (Ipv4Address replyTo, Ipv4Address replyFrom, Time gratReplyHoldoff)
{
...
bool
RushattackdsrGraReply::AddEntry (GraReplyEntry & graTableEntry)
{
