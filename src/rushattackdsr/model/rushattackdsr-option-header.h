...
/**
 * \class RushattackdsrOptionHeader
 * \brief Header for Rushattackdsr Options.
 */
class RushattackdsrOptionHeader : public Header
{
public:
  /**
   * \struct Alignment
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionHeader ();
  /**
...
/**
 * \class RushattackdsrOptionPad1Header
 * \brief Header of Rushattackdsr Option Pad1
 */
class RushattackdsrOptionPad1Header : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionPad1Header ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionPad1Header ();
  /**
   * \brief Print some information about the packet.
   * \param os output stream
   * \return info about this packet
...
/**
 * \class RushattackdsrOptionPadnHeader
 * \brief Header of Rushattackdsr Option Padn
 */
class RushattackdsrOptionPadnHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   */
  RushattackdsrOptionPadnHeader (uint32_t pad = 2);
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionPadnHeader ();
  /**
   * \brief Print some information about the packet.
   * \param os output stream
   * \return info about this packet
...
/**
 * \class RushattackdsrOptionRouteRequestHeader
 * \brief Header of Rushattackdsr Option Route Request
 */
...
class RushattackdsrOptionRreqHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionRreqHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionRreqHeader ();
  /**
...
/**
 * \class RushattackdsrOptionRrepHeader
 * \brief Header of Rushattackdsr Option Route Reply
 */
...
class RushattackdsrOptionRrepHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionRrepHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionRrepHeader ();
  /**
   * \brief Set the number of ipv4 address.
   * \param n the number of ipv4 address
   */
...
/**
 * \class RushattackdsrOptionSRHeader
 * \brief Header of Rushattackdsr Option Source Route
 */
...
class RushattackdsrOptionSRHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionSRHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionSRHeader ();
  /**
  ...
  /**
   * TracedCallback signature for RushattackdsrOptionSrHeader.
   *
   * \param [in] header The RushattackdsrOptionsSRHeader
   */
  typedef void (*TracedCallback)(const RushattackdsrOptionSRHeader & header);
...
/**
 * \class RushattackdsrOptionRerrHeader
 * \brief Header of Rushattackdsr Option Route Error
 */
...
class RushattackdsrOptionRerrHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionRerrHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionRerrHeader ();
  /**
...
class RushattackdsrOptionRerrUnreachHeader : public RushattackdsrOptionRerrHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionRerrUnreachHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionRerrUnreachHeader ();
  /**
   * \brief Set the route error source address
   * \param errorSrcAddress The error source address
   */
...
class RushattackdsrOptionRerrUnsupportHeader : public RushattackdsrOptionRerrHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionRerrUnsupportHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionRerrUnsupportHeader ();
  /**
   * \brief Set the route error source address
   * \param errorSrcAddress The error source address
   */
...
/**
 * \class RushattackdsrOptionAckReqHeader
 * \brief Header of Rushattackdsr Option ack request
 */
...
class RushattackdsrOptionAckReqHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionAckReqHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionAckReqHeader ();
  /**
...
/**
 * \class RushattackdsrOptionAckHeader
 * \brief Header of Rushattackdsr Option ack
 */
...
class RushattackdsrOptionAckHeader : public RushattackdsrOptionHeader
{
public:
  /**
   * \brief Get the type identificator.
   ...
   * \brief Constructor.
   */
  RushattackdsrOptionAckHeader ();
  /**
   * \brief Destructor.
   */
  virtual ~RushattackdsrOptionAckHeader ();
  /**
...
static inline std::ostream & operator<< (std::ostream& os, const RushattackdsrOptionSRHeader & sr)
{
  sr.Print (os);
  return os;
}
