 ...
 */
class RushattackdsrErrorBuffEntry
{
public:
  /**
   * Create an RushattackdsrErrorBuffEntry with the given parameters.
   *
   * \param pa packet
   ...
   */
  RushattackdsrErrorBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (), Ipv4Address s = Ipv4Address (),
   ...
   * \param o another RushattackdsrErrorBuffEntry
   * \return true if equal
   */
  bool operator== (RushattackdsrErrorBuffEntry const & o) const
  {
 ...
 */
/************************************************************************************************************************/
class RushattackdsrErrorBuffer
{
public:
  /**
   * Default constructor
   */
  RushattackdsrErrorBuffer ()
  {
  }
  /**
   ...
   */
  bool Enqueue (RushattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  bool Dequeue (Ipv4Address dst, RushattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  std::vector<RushattackdsrErrorBuffEntry> & GetBuffer ()
  {
...
private:
  ...
  std::vector<RushattackdsrErrorBuffEntry> m_errorBuffer;
   ...
   */
  ///
  void Drop (RushattackdsrErrorBuffEntry en, std::string reason);
  /**
   * Notify that packet is dropped from queue by link error
   * \param en Error Buffer Entry
   * \param reason Drop reason.
   */
  void DropLink (RushattackdsrErrorBuffEntry en, std::string reason);
   ...
   */
  ///
  static bool LinkEqual (RushattackdsrErrorBuffEntry en, const std::vector<Ipv4Address> link)
  {
