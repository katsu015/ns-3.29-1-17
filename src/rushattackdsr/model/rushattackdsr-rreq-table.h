 ...
 */
class RushattackdsrReceivedRreqEntry
{
public:
  /**
   * Construct a RushattackdsrReceivedRreqEntry with the given parameters
   *
   * \param d IPv4 address of the destination
   * \param i identification
   */
  RushattackdsrReceivedRreqEntry (Ipv4Address d = Ipv4Address (), uint16_t i = 0)
    : m_destination (d),
      m_identification (i)
  {
  }
   ...
   * \param o another RushattackdsrReceivedRreqEntry
   * \return true if equal
   */
  bool operator== (RushattackdsrReceivedRreqEntry const & o) const
  {
 ...
 * \brief maintain list of RushattackdsrRreqTable entry
 */
class RushattackdsrRreqTable  : public Object
{
public:
  /**
  ...
  RushattackdsrRreqTable ();
  virtual ~RushattackdsrRreqTable ();
...
private:
  ...
  /// Map of entries
  std::list<RushattackdsrReceivedRreqEntry> m_sourceRequests;
  ...
  std::map<Ipv4Address, std::list<RushattackdsrReceivedRreqEntry> > m_sourceRreqMap;
