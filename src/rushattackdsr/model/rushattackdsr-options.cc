...
NS_LOG_COMPONENT_DEFINE ("RushattackdsrOptions");

namespace rushattackdsr {

NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptions);

TypeId RushattackdsrOptions::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptions")
    .SetParent<Object> ()
    .SetGroupName ("Rushattackdsr")
    .AddAttribute ("OptionNumber", "The Rushattackdsr option number.",
                   UintegerValue (0),
                   MakeUintegerAccessor (&RushattackdsrOptions::GetOptionNumber),
                   MakeUintegerChecker<uint8_t> ())
    .AddTraceSource ("Drop",
                     "Packet dropped.",
                     MakeTraceSourceAccessor (&RushattackdsrOptions::m_dropTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("Rx",
                     "Receive DSR packet.",
                     MakeTraceSourceAccessor (&RushattackdsrOptions::m_rxPacketTrace),
                     "ns3::rushattackdsr::RushattackdsrOptionSRHeader::TracedCallback")
  ;
  return tid;
}

RushattackdsrOptions::RushattackdsrOptions ()
{
...
void RushattackdsrOptions::SetNode (Ptr<Node> node)
{
  NS_LOG_FUNCTION (this << node);
  m_node = node;
}

Ptr<Node> RushattackdsrOptions::GetNode () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_node;
}

bool RushattackdsrOptions::ContainAddressAfter (Ipv4Address ipv4Address, Ipv4Address destAddress, std::vector<Ipv4Address> &nodeList)
{
...
RushattackdsrOptions::CutRoute (Ipv4Address ipv4Address, std::vector<Ipv4Address> &nodeList)
{
...
Ptr<Ipv4Route> RushattackdsrOptions::SetRoute (Ipv4Address nextHop, Ipv4Address srcAddress)
{
...
bool RushattackdsrOptions::ReverseRoutes (std::vector<Ipv4Address> & vec)
{
...
Ipv4Address RushattackdsrOptions::SearchNextHop (Ipv4Address ipv4Address, std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this << ipv4Address);
  Ipv4Address nextHop;
...
Ipv4Address RushattackdsrOptions::ReverseSearchNextHop (Ipv4Address ipv4Address, std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this << ipv4Address);
  Ipv4Address nextHop;
  if (vec.size () == 2)
...
Ipv4Address RushattackdsrOptions::ReverseSearchNextTwoHop  (Ipv4Address ipv4Address, std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this << ipv4Address);
...
void RushattackdsrOptions::PrintVector (std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this);
  /*
...
bool RushattackdsrOptions::IfDuplicates (std::vector<Ipv4Address>& vec, std::vector<Ipv4Address>& vec2)
{
  NS_LOG_FUNCTION (this);
  for (std::vector<Ipv4Address>::const_iterator i = vec.begin (); i != vec.end (); ++i)
    {
...
bool RushattackdsrOptions::CheckDuplicates (Ipv4Address ipv4Address, std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this << ipv4Address);
  for (std::vector<Ipv4Address>::const_iterator i = vec.begin (); i != vec.end (); ++i)
    {
...
void RushattackdsrOptions::RemoveDuplicates (std::vector<Ipv4Address>& vec)
{
  NS_LOG_FUNCTION (this);
...
uint32_t
RushattackdsrOptions::GetIDfromIP (Ipv4Address address)
{
...
Ptr<Node> RushattackdsrOptions::GetNodeWithAddress (Ipv4Address ipv4Address)
{
  NS_LOG_FUNCTION (this << ipv4Address);
  int32_t nNodes = NodeList::GetNNodes ();
  for (int32_t i = 0; i < nNodes; ++i)
...
NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionPad1);

TypeId RushattackdsrOptionPad1::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionPad1")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionPad1> ()
  ;
  return tid;
}

RushattackdsrOptionPad1::RushattackdsrOptionPad1 ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
uint8_t RushattackdsrOptionPad1::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t RushattackdsrOptionPad1::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);
  Ptr<Packet> p = packet->Copy ();
  RushattackdsrOptionPad1Header pad1Header;
...
NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionPadn);

TypeId RushattackdsrOptionPadn::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionPadn")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionPadn> ()
  ;
  return tid;
}

RushattackdsrOptionPadn::RushattackdsrOptionPadn ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
uint8_t RushattackdsrOptionPadn::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return OPT_NUMBER;
}

uint8_t RushattackdsrOptionPadn::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);

  Ptr<Packet> p = packet->Copy ();
  RushattackdsrOptionPadnHeader padnHeader;
...
NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionRreq);

TypeId RushattackdsrOptionRreq::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionRreq")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionRreq> ()
  ;
  return tid;
}

TypeId RushattackdsrOptionRreq::GetInstanceTypeId () const
{
  return GetTypeId ();
}

RushattackdsrOptionRreq::RushattackdsrOptionRreq ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
uint8_t RushattackdsrOptionRreq::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t RushattackdsrOptionRreq::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  u_int8_t malicious = 7;

  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header <<
  ...
  Ptr<Packet> p = packet->Copy (); // Note: The packet here doesn't contain the fixed size rushattackdsr header
  /*
  ...
  /*
   * Create the rushattackdsr rreq header
   */
  RushattackdsrOptionRreqHeader rreq;
  /*
  ...
  /*
   * Construct the rushattackdsr routing header for later use
   */
  ...
  if (ttl)
    {
      ...
      dupRequest = rushattackdsr->FindSourceEntry (sourceAddress, targetAddress, requestId);
    }
  /*
  ...
  if (dupRequest)
  ...
  else
    {
      ...
      RushattackdsrRouteCacheEntry toPrev;
      bool isRouteInCache = rushattackdsr->LookupRoute (targetAddress,
                                              toPrev);
      RushattackdsrRouteCacheEntry::IP_VECTOR ip = toPrev.GetVector (); // The route from our own route cache to dst
      PrintVector (ip);
      ...
      if (targetAddress == ipv4Address)
        {
          ...
          /*
           * This part add rushattackdsr header to the packet and send route reply packet
           */
          RushattackdsrRoutingHeader rushattackdsrRoutingHeader;
          rushattackdsrRoutingHeader.SetNextHeader (protocol);
          rushattackdsrRoutingHeader.SetMessageType (1);
          rushattackdsrRoutingHeader.SetSourceId (GetIDfromIP (ipv4Address));
          ...
          rushattackdsrRoutingHeader.SetPayloadLength (length + 2);
          rushattackdsrRoutingHeader.AddRushattackdsrOption (rrep);
          Ptr<Packet> newPacket = Create<Packet> ();
          newPacket->AddHeader (rushattackdsrRoutingHeader);
          rushattackdsr->ScheduleInitialReply (newPacket, ipv4Address, nextHop, m_ipv4Route);
          /*
          ...
          if (ReverseRoutes (m_finalRoute))
            {
              ...
              if (numberAddress > 0)
                {
                  RushattackdsrRouteCacheEntry toSource (/*IP_VECTOR=*/ m_finalRoute, /*dst=*/
                                                              dst, /*expire time=*/ ActiveRouteTimeout);
                  if (rushattackdsr->IsLinkCache ())
                    {
                      addRoute = rushattackdsr->AddRoute_Link (m_finalRoute, ipv4Address);
                    }
                  else
                    {
                      addRoute = rushattackdsr->AddRoute (toSource);
                    }
                }
              else
                {
              ...
              if (addRoute)
                {
                  ...
                  // if (rushattackdsr->IsLinkCache ())
                  //   {
                  //     rushattackdsr->UseExtends (m_finalRoute);
                  //   }
                  ...
                  if (nextHop == "0.0.0.0")
                    {
                      rushattackdsr->PacketNewRoute (rushattackdsrP, ipv4Address, dst, protocol);
                      return 0;
                    }
                  SetRoute (nextHop, ipv4Address);
                  /*
                   ...
                   */
                  rushattackdsr->SendPacketFromBuffer (sourceRoute, nextHop, protocol);
                  // Cancel the route request timer for destination after sending the data packet
                  rushattackdsr->CancelRreqTimer (dst, true);
                }
              else
                {
       ...
       */
      else if (isRouteInCache && !areThereDuplicates)
        {
          ...
          if (ReverseRoutes (reverseRoute))
            {
              ...
              RushattackdsrRouteCacheEntry toSource (/*IP_VECTOR=*/ saveRoute, /*dst=*/ dst, /*expire time=*/ ActiveRouteTimeout);
              NS_ASSERT (saveRoute.front () == ipv4Address);
              // Add the route entry in the route cache
              if (rushattackdsr->IsLinkCache ())
                {
                  addRoute = rushattackdsr->AddRoute_Link (saveRoute, ipv4Address);
                }
              else
                {
                  addRoute = rushattackdsr->AddRoute (toSource);
              ...
              if (addRoute)
                {
                  ...
                  // if (rushattackdsr->IsLinkCache ())
                  //   {
                  //     rushattackdsr->UseExtends (saveRoute);
                  //   }
          ...
          rushattackdsrRoutingHeader.SetNextHeader (protocol);
          rushattackdsrRoutingHeader.SetMessageType (1);
          rushattackdsrRoutingHeader.SetSourceId (GetIDfromIP (realSource));
          rushattackdsrRoutingHeader.SetDestId (255);
          ...
          Ptr<Packet> newPacket = Create<Packet> ();
          newPacket->AddHeader (rushattackdsrRoutingHeader);
          rushattackdsr->ScheduleCachedReply (newPacket, ipv4Address, nextHop, m_ipv4Route, hops);
          isPromisc = false;
          return rreq.GetSerializedSize ();
        }
      /*
              ...
              if ((errorSrc == srcAddress) && (unreachNode == ipv4Address))
                {
                  ...
                  rushattackdsrRoutingHeader.AddRushattackdsrOption (rreq);
                  rushattackdsrRoutingHeader.SetPayloadLength (length + 2);
                }
              else
                {
                  rushattackdsr->DeleteAllRoutesIncludeLink (errorSrc, unreachNode, ipv4Address);
                  ...
                  rushattackdsrRoutingHeader.SetPayloadLength (length + 4);
                  rushattackdsrRoutingHeader.AddRushattackdsrOption (rreq);
          ...
          if (ttl)
            {
              ...
              interP->AddHeader (rushattackdsrRoutingHeader);
              rushattackdsr->ScheduleInterRequest (interP);
              isPromisc = false;
            }
          return rreq.GetSerializedSize ();
        }
...
NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionRrep);

TypeId RushattackdsrOptionRrep::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionRrep")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionRrep> ()
  ;
  return tid;
}

RushattackdsrOptionRrep::RushattackdsrOptionRrep ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
TypeId RushattackdsrOptionRrep::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint8_t RushattackdsrOptionRrep::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t RushattackdsrOptionRrep::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);
  ...
  if (targetAddress == ipv4Address)
    {
       ...
       */
      RushattackdsrRouteCacheEntry toDestination (/*IP_VECTOR=*/ nodeList, /*dst=*/ dst, /*expire time=*/ ActiveRouteTimeout);
      NS_ASSERT (nodeList.front () == ipv4Address);
      bool addRoute = false;
      if (rushattackdsr->IsLinkCache ())
        {
          addRoute = rushattackdsr->AddRoute_Link (nodeList, ipv4Address);
        }
      else
        {
          addRoute = rushattackdsr->AddRoute (toDestination);
        }
  ...
  else
    {
      ...
      if (cutRoute.size () >= 2)
        {
          ...
          RushattackdsrRouteCacheEntry toDestination (/*IP_VECTOR=*/ cutRoute, /*dst=*/ dst, /*expire time=*/ ActiveRouteTimeout);
      ...
      SetRoute (nextHop, ipv4Address);
      /*
       * This part add rushattackdsr routing header to the packet and send reply
       */
      RushattackdsrRoutingHeader rushattackdsrRoutingHeader;
      rushattackdsrRoutingHeader.SetNextHeader (protocol);
      ...
      Ptr<Packet> newPacket = Create<Packet> ();
      newPacket->AddHeader (rushattackdsrRoutingHeader);
      rushattackdsr->SendReply (newPacket, ipv4Address, nextHop, m_ipv4Route);
      isPromisc = false;
    }
  return rrep.GetSerializedSize ();
}

NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionSR);

TypeId RushattackdsrOptionSR::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionSR")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionSR> ()
  ;
  return tid;
}

RushattackdsrOptionSR::RushattackdsrOptionSR ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
TypeId RushattackdsrOptionSR::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint8_t RushattackdsrOptionSR::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return OPT_NUMBER;
}

uint8_t RushattackdsrOptionSR::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Address << ipv4Header << (uint32_t)protocol << isPromisc);
  Ptr<Packet> p = packet->Copy ();
  // Get the number of routers' address field
  uint8_t buf[2];
  p->CopyData (buf, sizeof(buf));
  ...
  if (isPromisc)
      ...
      if (ContainAddressAfter (ipv4Address, destAddress, nodeList))
        {
          ...
          rushattackdsr->SendGratuitousReply (source, srcAddress, nodeList, protocol);
        }
          ...
          for (int32_t i = 0; i < nNodes; ++i)
            {
              ...
              Ptr<Node> node = NodeList::GetNode (i);
              Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsrNode = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
              // The source and destination addresses here are the real source and destination for the packet
              findPassive = rushattackdsrNode->PassiveEntryCheck (packet, source, destination, segsLeft, fragmentOffset, identification, false);
              if (findPassive)
                {
                  break;
                }
          ...
          if (findPassive)
            {
              ...
              Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsrSrc = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
              rushattackdsrSrc->CancelPassiveTimer (packet, source, destination, segsLeft);
            }
          else
            {
              NS_LOG_DEBUG ("Saved the entry for further use");
              rushattackdsr->PassiveEntryCheck (packet, source, destination, segsLeft, fragmentOffset, identification, true);
            }
        }
  ...
  else
    {
      ...
      if (optionType == 160)
        {
          ...
          rushattackdsr->SendAck (ackId, ackAddress, source, destination, protocol, m_ipv4Route);
        }
      /*
      ...
      RushattackdsrOptionSRHeader newSourceRoute;
      ...
      if (nextHop == "0.0.0.0")
        {
          NS_LOG_DEBUG ("Before new packet " << *rushattackdsrP);
          rushattackdsr->PacketNewRoute (rushattackdsrP, realSource, targetAddress, protocol);
          return 0;
        }
      ...
      NS_LOG_DEBUG ("rushattackdsr packet size " << rushattackdsrP->GetSize ());
      rushattackdsr->ForwardPacket (rushattackdsrP, newSourceRoute, ipv4Header, realSource, nextAddress, targetAddress, protocol, m_ipv4Route);
    }
  return sourceRoute.GetSerializedSize ();
}

NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionRerr);

TypeId RushattackdsrOptionRerr::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionRerr")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionRerr> ()
  ;
  return tid;
}

RushattackdsrOptionRerr::RushattackdsrOptionRerr ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
TypeId RushattackdsrOptionRerr::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint8_t RushattackdsrOptionRerr::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return OPT_NUMBER;
}

uint8_t RushattackdsrOptionRerr::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);
  Ptr<Packet> p = packet->Copy ();
  uint32_t size = p->GetSize ();
  ...
  /*
   * Get the node from Ip address and get the rushattackdsr extension object
   */
  Ptr<Node> node = GetNodeWithAddress (ipv4Address);
  Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsr = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
  /*
  ...
  if (errorType == 1) // unreachable ip address
    {
       ...
       */
      RushattackdsrOptionRerrUnreachHeader rerrUnreach;
       ...
       */
      Ptr<Node> node = GetNodeWithAddress (ipv4Address);
      rushattackdsr->DeleteAllRoutesIncludeLink (errorSource, unreachAddress, ipv4Address);
  ...
  else
    {
       ...
       * Remove the route error header from the packet, and get the error type
       */
      RushattackdsrOptionRerrUnsupportHeader rerrUnsupport;
...
uint8_t RushattackdsrOptionRerr::DoSendError (Ptr<Packet> p, RushattackdsrOptionRerrUnreachHeader &rerr, uint32_t rerrSize, Ipv4Address ipv4Address, uint8_t protocol)
{
  // Get the number of routers' address field
  uint8_t buf[2];
  p->CopyData (buf, sizeof(buf));
  ...
  /*
   * Get the node from ip address and the rushattackdsr extension object
   */
  Ptr<Node> node = GetNodeWithAddress (ipv4Address);
  Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsr = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
  /*
  ...
  if (segmentsLeft == 0 && targetAddress == ipv4Address)
    {
      ...
      rushattackdsr->SendErrorRequest (rerr, protocol);
  ...
  // Set the route entry
  SetRoute (nextAddress, ipv4Address);
  rushattackdsr->ForwardErrPacket (rerr, newSourceRoute, nextAddress, protocol, m_ipv4Route);
  return serializedSize;
}

NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionAckReq);

TypeId RushattackdsrOptionAckReq::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionAckReq")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionAckReq> ()
  ;
  return tid;
}

RushattackdsrOptionAckReq::RushattackdsrOptionAckReq ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
TypeId RushattackdsrOptionAckReq::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint8_t RushattackdsrOptionAckReq::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return OPT_NUMBER;
}

uint8_t RushattackdsrOptionAckReq::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);
  /*
  ...
  p->RemoveHeader (ackReq);
  /*
   * Get the node with ip address and get the rushattackdsr extension and reoute cache objects
   */
  Ptr<Node> node = GetNodeWithAddress (ipv4Address);
  Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsr = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
...
NS_OBJECT_ENSURE_REGISTERED (RushattackdsrOptionAck);

TypeId RushattackdsrOptionAck::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::rushattackdsr::RushattackdsrOptionAck")
    .SetParent<RushattackdsrOptions> ()
    .SetGroupName ("Rushattackdsr")
    .AddConstructor<RushattackdsrOptionAck> ()
  ;
  return tid;
}

RushattackdsrOptionAck::RushattackdsrOptionAck ()
{
  NS_LOG_FUNCTION_NOARGS ();
}
...
TypeId RushattackdsrOptionAck::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint8_t RushattackdsrOptionAck::GetOptionNumber () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return OPT_NUMBER;
}

uint8_t RushattackdsrOptionAck::Process (Ptr<Packet> packet, Ptr<Packet> rushattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource)
{
  ackcount++;
  printf("ackcount=%d\n",ackcount );
  NS_LOG_FUNCTION (this << packet << rushattackdsrP << ipv4Address << source << ipv4Header << (uint32_t)protocol << isPromisc);
  ...
  /*
   * Get the node with ip address and get the rushattackdsr extension and route cache objects
   */
  Ptr<Node> node = GetNodeWithAddress (ipv4Address);
  Ptr<rushattackdsr::RushattackdsrRouting> rushattackdsr = node->GetObject<rushattackdsr::RushattackdsrRouting> ();
  rushattackdsr->UpdateRouteEntry (realDst);
  /*
   * Cancel the packet retransmit timer when receiving the ack packet
   */
  rushattackdsr->CallCancelPacketTimer (ackId, ipv4Header, realSrc, realDst);
