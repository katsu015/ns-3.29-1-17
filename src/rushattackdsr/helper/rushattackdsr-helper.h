 ...
 *        IP layers.
 */
class RushattackdsrHelper
{
public:
  /**
   * Create an RushattackdsrHelper that makes life easier for people who want to install
   * Rushattackdsr routing to nodes.
   */
  RushattackdsrHelper ();
  ~RushattackdsrHelper ();
  /**
   * \brief Construct an RushattackdsrHelper from another previously initialized instance
   * (Copy Constructor).
   */
  RushattackdsrHelper (const RushattackdsrHelper &);
  /**
   * \returns pointer to clone of this RushattackdsrHelper
   *
   ...
   */
  Ptr<ns3::rushattackdsr::RushattackdsrRouting> Create (Ptr<Node> node) const;
  /**
...
private:
   ...
   */
  RushattackdsrHelper & operator = (const RushattackdsrHelper &o);
