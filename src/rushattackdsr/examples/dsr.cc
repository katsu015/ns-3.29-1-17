...
#include "ns3/youngrushattackdsr-module.h"
...
#endif
//LogComponentEnable ("RushattackdsrOptions", LOG_LEVEL_ALL);
#if 0
  LogComponentEnable ("RushattackdsrOptions", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrHelper", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrRouting", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrOptionHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrFsHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrGraReplyTable", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrSendBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrRouteCache", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrMaintainBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrRreqTable", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrErrorBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("RushattackdsrNetworkQueue", LOG_LEVEL_ALL);
#endif
  ...
  YoungRushattackdsrHelper rushattackdsr;
