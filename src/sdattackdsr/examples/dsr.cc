...
#include "ns3/youngsdattackdsr-module.h"
...
#endif
//LogComponentEnable ("SdattackdsrOptions", LOG_LEVEL_ALL);
#if 0
  LogComponentEnable ("SdattackdsrOptions", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrHelper", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrRouting", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrOptionHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrFsHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrGraReplyTable", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrSendBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrRouteCache", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrMaintainBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrRreqTable", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrErrorBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("SdattackdsrNetworkQueue", LOG_LEVEL_ALL);
#endif
  ...
  YoungSdattackdsrHelper sdattackdsr;
