...
def module_init():
    root_module = Module('ns.sdattackdsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## sdattackdsr-helper.h (module 'sdattackdsr'): ns3::SdattackdsrHelper [class]
    module.add_class('SdattackdsrHelper')
    ## sdattackdsr-main-helper.h (module 'sdattackdsr'): ns3::SdattackdsrMainHelper [class]
    module.add_class('SdattackdsrMainHelper')
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', template_parameters=['void', 'const ns3::sdattackdsr::SdattackdsrOptionSRHeader &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'], parent=root_module['ns3::CallbackImplBase'])
    ...
    ## Register a nested module for the namespace sdattackdsr
    
    nested_module = module.add_cpp_namespace('sdattackdsr')
    register_types_ns3_sdattackdsr(nested_module)
...
def register_types_ns3_sdattackdsr(module):
    root_module = module.get_root()
    
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkStates [enumeration]
    module.add_enum('LinkStates', ['PROBABLE', 'QUESTIONABLE'])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMessageType [enumeration]
    module.add_enum('SdattackdsrMessageType', ['DSR_CONTROL_PACKET', 'DSR_DATA_PACKET'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::ErrorType [enumeration]
    module.add_enum('ErrorType', ['NODE_UNREACHABLE', 'FLOW_STATE_NOT_SUPPORTED', 'OPTION_NOT_SUPPORTED'])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList [struct]
    module.add_class('BlackList')
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffEntry [class]
    module.add_class('SdattackdsrErrorBuffEntry')
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffer [class]
    module.add_class('SdattackdsrErrorBuffer')
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrFsHeader [class]
    module.add_class('SdattackdsrFsHeader', parent=root_module['ns3::Header'])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrGraReply [class]
    module.add_class('SdattackdsrGraReply', parent=root_module['ns3::Object'])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrLinkStab [class]
    module.add_class('SdattackdsrLinkStab')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffEntry [class]
    module.add_class('SdattackdsrMaintainBuffEntry')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffer [class]
    module.add_class('SdattackdsrMaintainBuffer')
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueue [class]
    module.add_class('SdattackdsrNetworkQueue', parent=root_module['ns3::Object'])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueueEntry [class]
    module.add_class('SdattackdsrNetworkQueueEntry')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNodeStab [class]
    module.add_class('SdattackdsrNodeStab')
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionField [class]
    module.add_class('SdattackdsrOptionField')
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader [class]
    module.add_class('SdattackdsrOptionHeader', parent=root_module['ns3::Header'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment [struct]
    module.add_class('Alignment', outer_class=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1Header [class]
    module.add_class('SdattackdsrOptionPad1Header', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadnHeader [class]
    module.add_class('SdattackdsrOptionPadnHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrHeader [class]
    module.add_class('SdattackdsrOptionRerrHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader [class]
    module.add_class('SdattackdsrOptionRerrUnreachHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionRerrHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader [class]
    module.add_class('SdattackdsrOptionRerrUnsupportHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionRerrHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrepHeader [class]
    module.add_class('SdattackdsrOptionRrepHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreqHeader [class]
    module.add_class('SdattackdsrOptionRreqHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSRHeader [class]
    module.add_class('SdattackdsrOptionSRHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    typehandlers.add_type_alias(u'void ( * ) ( ns3::sdattackdsr::SdattackdsrOptionSRHeader const & )', u'ns3::sdattackdsr::SdattackdsrOptionSRHeader::TracedCallback')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::sdattackdsr::SdattackdsrOptionSRHeader const & )*', u'ns3::sdattackdsr::SdattackdsrOptionSRHeader::TracedCallback*')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::sdattackdsr::SdattackdsrOptionSRHeader const & )&', u'ns3::sdattackdsr::SdattackdsrOptionSRHeader::TracedCallback&')
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptions [class]
    module.add_class('SdattackdsrOptions', parent=root_module['ns3::Object'])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffEntry [class]
    module.add_class('SdattackdsrPassiveBuffEntry')
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffer [class]
    module.add_class('SdattackdsrPassiveBuffer', parent=root_module['ns3::Object'])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrReceivedRreqEntry [class]
    module.add_class('SdattackdsrReceivedRreqEntry')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache [class]
    module.add_class('SdattackdsrRouteCache', parent=root_module['ns3::Object'])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::sdattackdsr::SdattackdsrRouteCache'])
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >', u'ns3::sdattackdsr::SdattackdsrRouteCache::routeVector')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >*', u'ns3::sdattackdsr::SdattackdsrRouteCache::routeVector*')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >&', u'ns3::sdattackdsr::SdattackdsrRouteCache::routeVector&')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCacheEntry [class]
    module.add_class('SdattackdsrRouteCacheEntry')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >*', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >&', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR&')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::Iterator')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator*', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::Iterator*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator&', u'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::Iterator&')
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouting [class]
    module.add_class('SdattackdsrRouting', parent=root_module['ns3::IpL4Protocol'])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRoutingHeader [class]
    module.add_class('SdattackdsrRoutingHeader', parent=[root_module['ns3::sdattackdsr::SdattackdsrFsHeader'], root_module['ns3::sdattackdsr::SdattackdsrOptionField']])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRreqTable [class]
    module.add_class('SdattackdsrRreqTable', parent=root_module['ns3::Object'])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffEntry [class]
    module.add_class('SdattackdsrSendBuffEntry')
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffer [class]
    module.add_class('SdattackdsrSendBuffer')
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry [struct]
    module.add_class('GraReplyEntry')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::Link [struct]
    module.add_class('Link')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey [struct]
    module.add_class('LinkKey')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey [struct]
    module.add_class('NetworkKey')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey [struct]
    module.add_class('PassiveKey')
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::RreqTableEntry [struct]
    module.add_class('RreqTableEntry')
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAck [class]
    module.add_class('SdattackdsrOptionAck', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckHeader [class]
    module.add_class('SdattackdsrOptionAckHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReq [class]
    module.add_class('SdattackdsrOptionAckReq', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReqHeader [class]
    module.add_class('SdattackdsrOptionAckReqHeader', parent=root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1 [class]
    module.add_class('SdattackdsrOptionPad1', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadn [class]
    module.add_class('SdattackdsrOptionPadn', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerr [class]
    module.add_class('SdattackdsrOptionRerr', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrep [class]
    module.add_class('SdattackdsrOptionRrep', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreq [class]
    module.add_class('SdattackdsrOptionRreq', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSR [class]
    module.add_class('SdattackdsrOptionSR', parent=root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    module.add_container('std::vector< ns3::sdattackdsr::SdattackdsrErrorBuffEntry >', 'ns3::sdattackdsr::SdattackdsrErrorBuffEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::sdattackdsr::SdattackdsrNetworkQueueEntry >', 'ns3::sdattackdsr::SdattackdsrNetworkQueueEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::Ipv4Address >', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::list< ns3::sdattackdsr::SdattackdsrRouteCacheEntry >', 'ns3::sdattackdsr::SdattackdsrRouteCacheEntry', container_type=u'list')
    module.add_container('std::list< std::vector< ns3::Ipv4Address > >', 'std::vector< ns3::Ipv4Address >', container_type=u'list')
    module.add_container('ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::vector< ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor >', 'ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor', container_type=u'vector')
    ...
    module.add_container('std::vector< ns3::sdattackdsr::SdattackdsrSendBuffEntry >', 'ns3::sdattackdsr::SdattackdsrSendBuffEntry', container_type=u'vector')
...
def register_methods(root_module):
    ...
    register_Ns3SdattackdsrHelper_methods(root_module, root_module['ns3::SdattackdsrHelper'])
    register_Ns3SdattackdsrMainHelper_methods(root_module, root_module['ns3::SdattackdsrMainHelper'])
    ...
    register_Ns3CallbackImpl__Void_Const_ns3SdattackdsrSdattackdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3SdattackdsrBlackList_methods(root_module, root_module['ns3::sdattackdsr::BlackList'])
    register_Ns3SdattackdsrSdattackdsrErrorBuffEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrErrorBuffEntry'])
    register_Ns3SdattackdsrSdattackdsrErrorBuffer_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrErrorBuffer'])
    register_Ns3SdattackdsrSdattackdsrFsHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrFsHeader'])
    register_Ns3SdattackdsrSdattackdsrGraReply_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrGraReply'])
    register_Ns3SdattackdsrSdattackdsrLinkStab_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrLinkStab'])
    register_Ns3SdattackdsrSdattackdsrMaintainBuffEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrMaintainBuffEntry'])
    register_Ns3SdattackdsrSdattackdsrMaintainBuffer_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrMaintainBuffer'])
    register_Ns3SdattackdsrSdattackdsrNetworkQueue_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrNetworkQueue'])
    register_Ns3SdattackdsrSdattackdsrNetworkQueueEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrNetworkQueueEntry'])
    register_Ns3SdattackdsrSdattackdsrNodeStab_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrNodeStab'])
    register_Ns3SdattackdsrSdattackdsrOptionField_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionField'])
    register_Ns3SdattackdsrSdattackdsrOptionHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionHeaderAlignment_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment'])
    register_Ns3SdattackdsrSdattackdsrOptionPad1Header_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionPad1Header'])
    register_Ns3SdattackdsrSdattackdsrOptionPadnHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionPadnHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionRerrHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRerrHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionRerrUnreachHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionRerrUnsupportHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionRrepHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRrepHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionRreqHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRreqHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionSRHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionSRHeader'])
    register_Ns3SdattackdsrSdattackdsrOptions_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptions'])
    register_Ns3SdattackdsrSdattackdsrPassiveBuffEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrPassiveBuffEntry'])
    register_Ns3SdattackdsrSdattackdsrPassiveBuffer_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrPassiveBuffer'])
    register_Ns3SdattackdsrSdattackdsrReceivedRreqEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrReceivedRreqEntry'])
    register_Ns3SdattackdsrSdattackdsrRouteCache_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRouteCache'])
    register_Ns3SdattackdsrSdattackdsrRouteCacheNeighbor_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor'])
    register_Ns3SdattackdsrSdattackdsrRouteCacheEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRouteCacheEntry'])
    register_Ns3SdattackdsrSdattackdsrRouting_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRouting'])
    register_Ns3SdattackdsrSdattackdsrRoutingHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRoutingHeader'])
    register_Ns3SdattackdsrSdattackdsrRreqTable_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrRreqTable'])
    register_Ns3SdattackdsrSdattackdsrSendBuffEntry_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrSendBuffEntry'])
    register_Ns3SdattackdsrSdattackdsrSendBuffer_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrSendBuffer'])
    register_Ns3SdattackdsrGraReplyEntry_methods(root_module, root_module['ns3::sdattackdsr::GraReplyEntry'])
    register_Ns3SdattackdsrLink_methods(root_module, root_module['ns3::sdattackdsr::Link'])
    register_Ns3SdattackdsrLinkKey_methods(root_module, root_module['ns3::sdattackdsr::LinkKey'])
    register_Ns3SdattackdsrNetworkKey_methods(root_module, root_module['ns3::sdattackdsr::NetworkKey'])
    register_Ns3SdattackdsrPassiveKey_methods(root_module, root_module['ns3::sdattackdsr::PassiveKey'])
    register_Ns3SdattackdsrRreqTableEntry_methods(root_module, root_module['ns3::sdattackdsr::RreqTableEntry'])
    register_Ns3SdattackdsrSdattackdsrOptionAck_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionAck'])
    register_Ns3SdattackdsrSdattackdsrOptionAckHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionAckHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionAckReq_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionAckReq'])
    register_Ns3SdattackdsrSdattackdsrOptionAckReqHeader_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionAckReqHeader'])
    register_Ns3SdattackdsrSdattackdsrOptionPad1_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionPad1'])
    register_Ns3SdattackdsrSdattackdsrOptionPadn_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionPadn'])
    register_Ns3SdattackdsrSdattackdsrOptionRerr_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRerr'])
    register_Ns3SdattackdsrSdattackdsrOptionRrep_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRrep'])
    register_Ns3SdattackdsrSdattackdsrOptionRreq_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionRreq'])
    register_Ns3SdattackdsrSdattackdsrOptionSR_methods(root_module, root_module['ns3::sdattackdsr::SdattackdsrOptionSR'])
    return
...
def register_Ns3SdattackdsrHelper_methods(root_module, cls):
    ## sdattackdsr-helper.h (module 'sdattackdsr'): ns3::SdattackdsrHelper::SdattackdsrHelper() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-helper.h (module 'sdattackdsr'): ns3::SdattackdsrHelper::SdattackdsrHelper(ns3::SdattackdsrHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::SdattackdsrHelper const &', 'arg0')])
    ## sdattackdsr-helper.h (module 'sdattackdsr'): ns3::SdattackdsrHelper * ns3::SdattackdsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::SdattackdsrHelper *', 
                   [], 
                   is_const=True)
    ## sdattackdsr-helper.h (module 'sdattackdsr'): ns3::Ptr<ns3::sdattackdsr::SdattackdsrRouting> ns3::SdattackdsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::sdattackdsr::SdattackdsrRouting >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## sdattackdsr-helper.h (module 'sdattackdsr'): void ns3::SdattackdsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return

def register_Ns3SdattackdsrMainHelper_methods(root_module, cls):
    ## sdattackdsr-main-helper.h (module 'sdattackdsr'): ns3::SdattackdsrMainHelper::SdattackdsrMainHelper() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-main-helper.h (module 'sdattackdsr'): ns3::SdattackdsrMainHelper::SdattackdsrMainHelper(ns3::SdattackdsrMainHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::SdattackdsrMainHelper const &', 'arg0')])
    ## sdattackdsr-main-helper.h (module 'sdattackdsr'): void ns3::SdattackdsrMainHelper::Install(ns3::SdattackdsrHelper & sdattackdsrHelper, ns3::NodeContainer nodes) [member function]
    cls.add_method('Install', 
                   'void', 
                   [param('ns3::SdattackdsrHelper &', 'sdattackdsrHelper'), param('ns3::NodeContainer', 'nodes')])
    ## sdattackdsr-main-helper.h (module 'sdattackdsr'): void ns3::SdattackdsrMainHelper::SetSdattackdsrHelper(ns3::SdattackdsrHelper & sdattackdsrHelper) [member function]
    cls.add_method('SetSdattackdsrHelper', 
                   'void', 
                   [param('ns3::SdattackdsrHelper &', 'sdattackdsrHelper')])
    return
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, visibility='protected', template_parameters=[u'ns3::sdattackdsr::SdattackdsrOptionSRHeader const&'])
    return
...
def register_Ns3CallbackImpl__Void_Const_ns3SdattackdsrSdattackdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::sdattackdsr::SdattackdsrOptionSRHeader const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, const ns3::sdattackdsr::SdattackdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::sdattackdsr::SdattackdsrOptionSRHeader const & arg0) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrOptionSRHeader const &', 'arg0')], 
                   is_pure_virtual=True, is_virtual=True, custom_name=u'__call__')
    return
...
def register_Ns3SdattackdsrBlackList_methods(root_module, cls):
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList::BlackList(ns3::sdattackdsr::BlackList const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::BlackList const &', 'arg0')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList::BlackList(ns3::Ipv4Address ip, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Time', 't')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList::m_linkStates [variable]
    cls.add_instance_attribute('m_linkStates', 'ns3::sdattackdsr::LinkStates', is_const=False)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrSdattackdsrErrorBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SdattackdsrErrorBuffEntry(ns3::sdattackdsr::SdattackdsrErrorBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrErrorBuffEntry const &', 'arg0')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SdattackdsrErrorBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Ptr<const ns3::Packet> ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrErrorBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3SdattackdsrSdattackdsrErrorBuffer_methods(root_module, cls):
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffer::SdattackdsrErrorBuffer(ns3::sdattackdsr::SdattackdsrErrorBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrErrorBuffer const &', 'arg0')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrErrorBuffer::SdattackdsrErrorBuffer() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrErrorBuffer::Dequeue(ns3::Ipv4Address dst, ns3::sdattackdsr::SdattackdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::sdattackdsr::SdattackdsrErrorBuffEntry &', 'entry')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffer::DropPacketForErrLink(ns3::Ipv4Address source, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketForErrLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrErrorBuffer::Enqueue(ns3::sdattackdsr::SdattackdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrErrorBuffEntry &', 'entry')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrErrorBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): std::vector<ns3::sdattackdsr::SdattackdsrErrorBuffEntry, std::allocator<ns3::sdattackdsr::SdattackdsrErrorBuffEntry> > & ns3::sdattackdsr::SdattackdsrErrorBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::sdattackdsr::SdattackdsrErrorBuffEntry > &', 
                   [])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrErrorBuffer::GetErrorBufferTimeout() const [member function]
    cls.add_method('GetErrorBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrErrorBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrErrorBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffer::SetErrorBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetErrorBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## sdattackdsr-errorbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrErrorBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3SdattackdsrSdattackdsrFsHeader_methods(root_module, cls):
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrFsHeader::SdattackdsrFsHeader(ns3::sdattackdsr::SdattackdsrFsHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrFsHeader const &', 'arg0')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrFsHeader::SdattackdsrFsHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrFsHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrFsHeader::GetDestId() const [member function]
    cls.add_method('GetDestId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrFsHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrFsHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrFsHeader::GetNextHeader() const [member function]
    cls.add_method('GetNextHeader', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrFsHeader::GetPayloadLength() const [member function]
    cls.add_method('GetPayloadLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrFsHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrFsHeader::GetSourceId() const [member function]
    cls.add_method('GetSourceId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrFsHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::SetDestId(uint16_t destId) [member function]
    cls.add_method('SetDestId', 
                   'void', 
                   [param('uint16_t', 'destId')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::SetMessageType(uint8_t messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('uint8_t', 'messageType')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::SetNextHeader(uint8_t protocol) [member function]
    cls.add_method('SetNextHeader', 
                   'void', 
                   [param('uint8_t', 'protocol')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::SetPayloadLength(uint16_t length) [member function]
    cls.add_method('SetPayloadLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrFsHeader::SetSourceId(uint16_t sourceId) [member function]
    cls.add_method('SetSourceId', 
                   'void', 
                   [param('uint16_t', 'sourceId')])
    return

def register_Ns3SdattackdsrSdattackdsrGraReply_methods(root_module, cls):
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrGraReply::SdattackdsrGraReply(ns3::sdattackdsr::SdattackdsrGraReply const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrGraReply const &', 'arg0')])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrGraReply::SdattackdsrGraReply() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrGraReply::AddEntry(ns3::sdattackdsr::GraReplyEntry & graTableEntry) [member function]
    cls.add_method('AddEntry', 
                   'bool', 
                   [param('ns3::sdattackdsr::GraReplyEntry &', 'graTableEntry')])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrGraReply::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrGraReply::FindAndUpdate(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, ns3::Time gratReplyHoldoff) [member function]
    ...
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrGraReply::GetGraTableSize() const [member function]
    cls.add_method('GetGraTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrGraReply::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrGraReply::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrGraReply::SetGraTableSize(uint32_t g) [member function]
    cls.add_method('SetGraTableSize', 
                   'void', 
                   [param('uint32_t', 'g')])
    return

def register_Ns3SdattackdsrSdattackdsrLinkStab_methods(root_module, cls):
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrLinkStab::SdattackdsrLinkStab(ns3::sdattackdsr::SdattackdsrLinkStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrLinkStab const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrLinkStab::SdattackdsrLinkStab(ns3::Time linkStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'linkStab', default_value='ns3::Simulator::Now()')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrLinkStab::GetLinkStability() const [member function]
    cls.add_method('GetLinkStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrLinkStab::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrLinkStab::SetLinkStability(ns3::Time linkStab) [member function]
    cls.add_method('SetLinkStability', 
                   'void', 
                   [param('ns3::Time', 'linkStab')])
    return

def register_Ns3SdattackdsrSdattackdsrMaintainBuffEntry_methods(root_module, cls):
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SdattackdsrMaintainBuffEntry(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry const &', 'arg0')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SdattackdsrMaintainBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address us=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address dst=ns3::Ipv4Address(), uint16_t ackId=0, uint8_t segs=0, ns3::Time exp=ns3::Simulator::Now()) [constructor]
    ...
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetOurAdd() const [member function]
    cls.add_method('GetOurAdd', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Ptr<const ns3::Packet> ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::GetSrc() const [member function]
    cls.add_method('GetSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetAckId(uint16_t ackId) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'ackId')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetDst(ns3::Ipv4Address n) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetOurAdd(ns3::Ipv4Address us) [member function]
    cls.add_method('SetOurAdd', 
                   'void', 
                   [param('ns3::Ipv4Address', 'us')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetSegsLeft(uint8_t segs) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'segs')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffEntry::SetSrc(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3SdattackdsrSdattackdsrMaintainBuffer_methods(root_module, cls):
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffer::SdattackdsrMaintainBuffer(ns3::sdattackdsr::SdattackdsrMaintainBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrMaintainBuffer const &', 'arg0')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrMaintainBuffer::SdattackdsrMaintainBuffer() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::AllEqual(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::Dequeue(ns3::Ipv4Address dst, ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffer::DropPacketWithNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::Enqueue(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrMaintainBuffer::GetMaintainBufferTimeout() const [member function]
    cls.add_method('GetMaintainBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrMaintainBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrMaintainBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::LinkEqual(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('LinkEqual', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::NetworkEqual(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('NetworkEqual', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrMaintainBuffer::PromiscEqual(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('PromiscEqual', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'entry')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffer::SetMaintainBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetMaintainBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrMaintainBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3SdattackdsrSdattackdsrNetworkQueue_methods(root_module, cls):
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueue::SdattackdsrNetworkQueue(ns3::sdattackdsr::SdattackdsrNetworkQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrNetworkQueue const &', 'arg0')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueue::SdattackdsrNetworkQueue() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueue::SdattackdsrNetworkQueue(uint32_t maxLen, ns3::Time maxDelay) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'maxDelay')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrNetworkQueue::Dequeue(ns3::sdattackdsr::SdattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrNetworkQueueEntry &', 'entry')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrNetworkQueue::Enqueue(ns3::sdattackdsr::SdattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrNetworkQueueEntry &', 'entry')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrNetworkQueue::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrNetworkQueue::FindPacketWithNexthop(ns3::Ipv4Address nextHop, ns3::sdattackdsr::SdattackdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('FindPacketWithNexthop', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::sdattackdsr::SdattackdsrNetworkQueueEntry &', 'entry')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueue::Flush() [member function]
    cls.add_method('Flush', 
                   'void', 
                   [])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrNetworkQueue::GetMaxNetworkDelay() const [member function]
    cls.add_method('GetMaxNetworkDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrNetworkQueue::GetMaxNetworkSize() const [member function]
    cls.add_method('GetMaxNetworkSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): std::vector<ns3::sdattackdsr::SdattackdsrNetworkQueueEntry, std::allocator<ns3::sdattackdsr::SdattackdsrNetworkQueueEntry> > & ns3::sdattackdsr::SdattackdsrNetworkQueue::GetQueue() [member function]
    cls.add_method('GetQueue', 
                   'std::vector< ns3::sdattackdsr::SdattackdsrNetworkQueueEntry > &', 
                   [])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrNetworkQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrNetworkQueue::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueue::SetMaxNetworkDelay(ns3::Time delay) [member function]
    cls.add_method('SetMaxNetworkDelay', 
                   'void', 
                   [param('ns3::Time', 'delay')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueue::SetMaxNetworkSize(uint32_t maxSize) [member function]
    cls.add_method('SetMaxNetworkSize', 
                   'void', 
                   [param('uint32_t', 'maxSize')])
    return

def register_Ns3SdattackdsrSdattackdsrNetworkQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SdattackdsrNetworkQueueEntry(ns3::sdattackdsr::SdattackdsrNetworkQueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrNetworkQueueEntry const &', 'arg0')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SdattackdsrNetworkQueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), ns3::Ptr<ns3::Ipv4Route> r=0) [constructor]
    ...
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::GetInsertedTimeStamp() const [member function]
    cls.add_method('GetInsertedTimeStamp', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::GetIpv4Route() const [member function]
    cls.add_method('GetIpv4Route', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::GetNextHopAddress() const [member function]
    cls.add_method('GetNextHopAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Ptr<const ns3::Packet> ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::GetSourceAddress() const [member function]
    cls.add_method('GetSourceAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SetInsertedTimeStamp(ns3::Time time) [member function]
    cls.add_method('SetInsertedTimeStamp', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SetIpv4Route(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetIpv4Route', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SetNextHopAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNextHopAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## sdattackdsr-network-queue.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNetworkQueueEntry::SetSourceAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetSourceAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    return

def register_Ns3SdattackdsrSdattackdsrNodeStab_methods(root_module, cls):
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNodeStab::SdattackdsrNodeStab(ns3::sdattackdsr::SdattackdsrNodeStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrNodeStab const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrNodeStab::SdattackdsrNodeStab(ns3::Time nodeStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'nodeStab', default_value='ns3::Simulator::Now()')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrNodeStab::GetNodeStability() const [member function]
    cls.add_method('GetNodeStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrNodeStab::SetNodeStability(ns3::Time nodeStab) [member function]
    cls.add_method('SetNodeStability', 
                   'void', 
                   [param('ns3::Time', 'nodeStab')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionField_methods(root_module, cls):
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionField::SdattackdsrOptionField(ns3::sdattackdsr::SdattackdsrOptionField const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionField const &', 'arg0')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionField::SdattackdsrOptionField(uint32_t optionsOffset) [constructor]
    cls.add_constructor([param('uint32_t', 'optionsOffset')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionField::AddSdattackdsrOption(ns3::sdattackdsr::SdattackdsrOptionHeader const & option) [member function]
    cls.add_method('AddSdattackdsrOption', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrOptionHeader const &', 'option')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionField::Deserialize(ns3::Buffer::Iterator start, uint32_t length) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'length')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::Buffer ns3::sdattackdsr::SdattackdsrOptionField::GetSdattackdsrOptionBuffer() [member function]
    cls.add_method('GetSdattackdsrOptionBuffer', 
                   'ns3::Buffer', 
                   [])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionField::GetSdattackdsrOptionsOffset() [member function]
    cls.add_method('GetSdattackdsrOptionsOffset', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionField::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionField::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
...
def register_Ns3SdattackdsrSdattackdsrOptionHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::SdattackdsrOptionHeader(ns3::sdattackdsr::SdattackdsrOptionHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::SdattackdsrOptionHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionHeader::GetLength() const [member function]
    cls.add_method('GetLength', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionHeader::GetType() const [member function]
    cls.add_method('GetType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionHeader::SetLength(uint8_t length) [member function]
    cls.add_method('SetLength', 
                   'void', 
                   [param('uint8_t', 'length')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionHeader::SetType(uint8_t type) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('uint8_t', 'type')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionHeaderAlignment_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment::Alignment() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment::Alignment(ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment::factor [variable]
    cls.add_instance_attribute('factor', 'uint8_t', is_const=False)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment::offset [variable]
    cls.add_instance_attribute('offset', 'uint8_t', is_const=False)
    return

def register_Ns3SdattackdsrSdattackdsrOptionPad1Header_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1Header::SdattackdsrOptionPad1Header(ns3::sdattackdsr::SdattackdsrOptionPad1Header const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionPad1Header const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1Header::SdattackdsrOptionPad1Header() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionPad1Header::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPad1Header::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionPad1Header::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPad1Header::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionPad1Header::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionPad1Header::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3SdattackdsrSdattackdsrOptionPadnHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadnHeader::SdattackdsrOptionPadnHeader(ns3::sdattackdsr::SdattackdsrOptionPadnHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionPadnHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadnHeader::SdattackdsrOptionPadnHeader(uint32_t pad=2) [constructor]
    cls.add_constructor([param('uint32_t', 'pad', default_value='2')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionPadnHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPadnHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionPadnHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPadnHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionPadnHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionPadnHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3SdattackdsrSdattackdsrOptionRerrHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SdattackdsrOptionRerrHeader(ns3::sdattackdsr::SdattackdsrOptionRerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRerrHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SdattackdsrOptionRerrHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetErrorType() const [member function]
    cls.add_method('GetErrorType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SetErrorType(uint8_t errorType) [member function]
    cls.add_method('SetErrorType', 
                   'void', 
                   [param('uint8_t', 'errorType')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrHeader::SetSalvage(uint8_t salvage) [member function]
...
def register_Ns3SdattackdsrSdattackdsrOptionRerrUnreachHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SdattackdsrOptionRerrUnreachHeader(ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SdattackdsrOptionRerrUnreachHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetOriginalDst() const [member function]
    cls.add_method('GetOriginalDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::GetUnreachNode() const [member function]
    cls.add_method('GetUnreachNode', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SetOriginalDst(ns3::Ipv4Address originalDst) [member function]
    cls.add_method('SetOriginalDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originalDst')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader::SetUnreachNode(ns3::Ipv4Address unreachNode) [member function]
    cls.add_method('SetUnreachNode', 
                   'void', 
                   [param('ns3::Ipv4Address', 'unreachNode')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionRerrUnsupportHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SdattackdsrOptionRerrUnsupportHeader(ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SdattackdsrOptionRerrUnsupportHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::GetUnsupported() const [member function]
    cls.add_method('GetUnsupported', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRerrUnsupportHeader::SetUnsupported(uint16_t optionType) [member function]
    cls.add_method('SetUnsupported', 
                   'void', 
                   [param('uint16_t', 'optionType')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionRrepHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrepHeader::SdattackdsrOptionRrepHeader(ns3::sdattackdsr::SdattackdsrOptionRrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRrepHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrepHeader::SdattackdsrOptionRrepHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetTargetAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) const [member function]
    cls.add_method('GetTargetAddress', 
                   'ns3::Ipv4Address', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRrepHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRrepHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRrepHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionRreqHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SdattackdsrOptionRreqHeader(ns3::sdattackdsr::SdattackdsrOptionRreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRreqHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SdattackdsrOptionRreqHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::AddNodeAddress(ns3::Ipv4Address ipv4) [member function]
    cls.add_method('AddNodeAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'ipv4')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetNodesAddresses() const [member function]
    cls.add_method('GetNodesAddresses', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetNodesNumber() const [member function]
    cls.add_method('GetNodesNumber', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetTarget() [member function]
    cls.add_method('GetTarget', 
                   'ns3::Ipv4Address', 
                   [])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SetId(uint16_t identification) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionRreqHeader::SetTarget(ns3::Ipv4Address target) [member function]
    cls.add_method('SetTarget', 
                   'void', 
                   [param('ns3::Ipv4Address', 'target')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionSRHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSRHeader::SdattackdsrOptionSRHeader(ns3::sdattackdsr::SdattackdsrOptionSRHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionSRHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSRHeader::SdattackdsrOptionSRHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionSRHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetNodeListSize() const [member function]
    cls.add_method('GetNodeListSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetSegmentsLeft() const [member function]
    cls.add_method('GetSegmentsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionSRHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionSRHeader::SetSegmentsLeft(uint8_t segmentsLeft) [member function]
    cls.add_method('SetSegmentsLeft', 
                   'void', 
                   [param('uint8_t', 'segmentsLeft')])
    return

def register_Ns3SdattackdsrSdattackdsrOptions_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptions::SdattackdsrOptions(ns3::sdattackdsr::SdattackdsrOptions const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptions const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptions::SdattackdsrOptions() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrOptions::CheckDuplicates(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('CheckDuplicates', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrOptions::ContainAddressAfter(ns3::Ipv4Address ipv4Address, ns3::Ipv4Address destAddress, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    ...
    ## sdattackdsr-options.h (module 'sdattackdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::sdattackdsr::SdattackdsrOptions::CutRoute(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    cls.add_method('CutRoute', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'nodeList')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptions::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ptr<ns3::Node> ns3::sdattackdsr::SdattackdsrOptions::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ptr<ns3::Node> ns3::sdattackdsr::SdattackdsrOptions::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptions::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptions::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrOptions::IfDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec2) [member function]
    cls.add_method('IfDuplicates', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec'), param('std::vector< ns3::Ipv4Address > &', 'vec2')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptions::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptions::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_pure_virtual=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptions::RemoveDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('RemoveDuplicates', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrOptions::ReverseRoutes(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseRoutes', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptions::ReverseSearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptions::ReverseSearchNextTwoHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextTwoHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptions::ScheduleReply(ns3::Ptr<ns3::Packet> & packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, ns3::Ipv4Address & source, ns3::Ipv4Address & destination) [member function]
    ...
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptions::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptions::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::sdattackdsr::SdattackdsrOptions::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
...
def register_Ns3SdattackdsrSdattackdsrPassiveBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SdattackdsrPassiveBuffEntry(ns3::sdattackdsr::SdattackdsrPassiveBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrPassiveBuffEntry const &', 'arg0')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SdattackdsrPassiveBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), uint16_t i=0, uint16_t f=0, uint8_t seg=0, ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetFragmentOffset() const [member function]
    cls.add_method('GetFragmentOffset', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Ptr<const ns3::Packet> ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetFragmentOffset(uint16_t f) [member function]
    cls.add_method('SetFragmentOffset', 
                   'void', 
                   [param('uint16_t', 'f')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetSegsLeft(uint8_t seg) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'seg')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3SdattackdsrSdattackdsrPassiveBuffer_methods(root_module, cls):
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffer::SdattackdsrPassiveBuffer(ns3::sdattackdsr::SdattackdsrPassiveBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrPassiveBuffer const &', 'arg0')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrPassiveBuffer::SdattackdsrPassiveBuffer() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrPassiveBuffer::AllEqual(ns3::sdattackdsr::SdattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrPassiveBuffEntry &', 'entry')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrPassiveBuffer::Dequeue(ns3::Ipv4Address dst, ns3::sdattackdsr::SdattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::sdattackdsr::SdattackdsrPassiveBuffEntry &', 'entry')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrPassiveBuffer::Enqueue(ns3::sdattackdsr::SdattackdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrPassiveBuffEntry &', 'entry')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrPassiveBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrPassiveBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrPassiveBuffer::GetPassiveBufferTimeout() const [member function]
    cls.add_method('GetPassiveBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrPassiveBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrPassiveBuffer::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## sdattackdsr-passive-buff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrPassiveBuffer::SetPassiveBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetPassiveBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3SdattackdsrSdattackdsrReceivedRreqEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SdattackdsrReceivedRreqEntry(ns3::sdattackdsr::SdattackdsrReceivedRreqEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrReceivedRreqEntry const &', 'arg0')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SdattackdsrReceivedRreqEntry(ns3::Ipv4Address d=ns3::Ipv4Address(), uint16_t i=0) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'd', default_value='ns3::Ipv4Address()'), param('uint16_t', 'i', default_value='0')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrReceivedRreqEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3SdattackdsrSdattackdsrRouteCache_methods(root_module, cls):
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::SdattackdsrRouteCache(ns3::sdattackdsr::SdattackdsrRouteCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRouteCache const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::SdattackdsrRouteCache() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::AddArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::AddNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Ipv4Address ownAddress, ns3::Time expire) [member function]
    ...
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::AddRoute(ns3::sdattackdsr::SdattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry &', 'rt')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::AddRoute_Link(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address node) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'node')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrRouteCache::CheckUniqueAckId(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('CheckUniqueAckId', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::ClearMac() [member function]
    cls.add_method('ClearMac', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::DelArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    ...
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::FindSameRoute(ns3::sdattackdsr::SdattackdsrRouteCacheEntry & rt, std::list<ns3::sdattackdsr::SdattackdsrRouteCacheEntry, std::allocator<ns3::sdattackdsr::SdattackdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('FindSameRoute', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry &', 'rt'), param('std::list< ns3::sdattackdsr::SdattackdsrRouteCacheEntry > &', 'rtVector')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrRouteCache::GetAckSize() [member function]
    cls.add_method('GetAckSize', 
                   'uint16_t', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetCacheTimeout() const [member function]
    cls.add_method('GetCacheTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::sdattackdsr::SdattackdsrRouteCache::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetInitStability() const [member function]
    cls.add_method('GetInitStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRouteCache::GetMaxCacheLen() const [member function]
    cls.add_method('GetMaxCacheLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRouteCache::GetMaxEntriesEachDst() const [member function]
    cls.add_method('GetMaxEntriesEachDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetMinLifeTime() const [member function]
    cls.add_method('GetMinLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint64_t ns3::sdattackdsr::SdattackdsrRouteCache::GetStabilityDecrFactor() const [member function]
    cls.add_method('GetStabilityDecrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): uint64_t ns3::sdattackdsr::SdattackdsrRouteCache::GetStabilityIncrFactor() const [member function]
    cls.add_method('GetStabilityIncrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::GetSubRoute() const [member function]
    cls.add_method('GetSubRoute', 
                   'bool', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::sdattackdsr::SdattackdsrRouteCache::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrRouteCache::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCache::GetUseExtends() const [member function]
    cls.add_method('GetUseExtends', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Mac48Address ns3::sdattackdsr::SdattackdsrRouteCache::LookupMacAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('LookupMacAddress', 
                   'ns3::Mac48Address', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::LookupRoute(ns3::Ipv4Address id, ns3::sdattackdsr::SdattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry &', 'rt')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::Print(std::ostream & os) [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::PrintRouteVector(std::list<ns3::sdattackdsr::SdattackdsrRouteCacheEntry, std::allocator<ns3::sdattackdsr::SdattackdsrRouteCacheEntry> > route) [member function]
    cls.add_method('PrintRouteVector', 
                   'void', 
                   [param('std::list< ns3::sdattackdsr::SdattackdsrRouteCacheEntry >', 'route')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::ProcessTxError(ns3::WifiMacHeader const & hdr) [member function]
    cls.add_method('ProcessTxError', 
                   'void', 
                   [param('ns3::WifiMacHeader const &', 'hdr')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::PurgeLinkNode() [member function]
    cls.add_method('PurgeLinkNode', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::PurgeMac() [member function]
    cls.add_method('PurgeMac', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::RebuildBestRouteTable(ns3::Ipv4Address source) [member function]
    cls.add_method('RebuildBestRouteTable', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::RemoveLastEntry(std::list<ns3::sdattackdsr::SdattackdsrRouteCacheEntry, std::allocator<ns3::sdattackdsr::SdattackdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('RemoveLastEntry', 
                   'void', 
                   [param('std::list< ns3::sdattackdsr::SdattackdsrRouteCacheEntry > &', 'rtVector')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetCacheTimeout(ns3::Time t) [member function]
    cls.add_method('SetCacheTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetCacheType(std::string type) [member function]
    cls.add_method('SetCacheType', 
                   'void', 
                   [param('std::string', 'type')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetCallback(ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetInitStability(ns3::Time initStability) [member function]
    cls.add_method('SetInitStability', 
                   'void', 
                   [param('ns3::Time', 'initStability')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetMaxCacheLen(uint32_t len) [member function]
    cls.add_method('SetMaxCacheLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetMaxEntriesEachDst(uint32_t entries) [member function]
    cls.add_method('SetMaxEntriesEachDst', 
                   'void', 
                   [param('uint32_t', 'entries')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetMinLifeTime(ns3::Time minLifeTime) [member function]
    cls.add_method('SetMinLifeTime', 
                   'void', 
                   [param('ns3::Time', 'minLifeTime')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetStabilityDecrFactor(uint64_t decrFactor) [member function]
    cls.add_method('SetStabilityDecrFactor', 
                   'void', 
                   [param('uint64_t', 'decrFactor')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetStabilityIncrFactor(uint64_t incrFactor) [member function]
    cls.add_method('SetStabilityIncrFactor', 
                   'void', 
                   [param('uint64_t', 'incrFactor')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetSubRoute(bool subRoute) [member function]
    cls.add_method('SetSubRoute', 
                   'void', 
                   [param('bool', 'subRoute')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::SetUseExtends(ns3::Time useExtends) [member function]
    cls.add_method('SetUseExtends', 
                   'void', 
                   [param('ns3::Time', 'useExtends')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::UpdateNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Time expire) [member function]
    cls.add_method('UpdateNeighbor', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodeList'), param('ns3::Time', 'expire')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::UpdateNetGraph() [member function]
    cls.add_method('UpdateNetGraph', 
                   'void', 
                   [])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCache::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCache::UseExtends(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_arp [variable]
    cls.add_instance_attribute('m_arp', 'std::vector< ns3::Ptr< ns3::ArpCache > >', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_delay [variable]
    cls.add_instance_attribute('m_delay', 'ns3::Time', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_handleLinkFailure [variable]
    ...
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_nb [variable]
    cls.add_instance_attribute('m_nb', 'std::vector< ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor >', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_ntimer [variable]
    cls.add_instance_attribute('m_ntimer', 'ns3::Timer', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::m_txErrorCallback [variable]
...
def register_Ns3SdattackdsrSdattackdsrRouteCacheNeighbor_methods(root_module, cls):
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::Neighbor(ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::Neighbor() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCache::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrSdattackdsrRouteCacheEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SdattackdsrRouteCacheEntry(ns3::sdattackdsr::SdattackdsrRouteCacheEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SdattackdsrRouteCacheEntry(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR const & ip=::ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR( ), ns3::Ipv4Address dst=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR const &', 'ip', default_value='::ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR( )'), param('ns3::Ipv4Address', 'dst', default_value='ns3::Ipv4Address()'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCacheEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrRouteCacheEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrRouteCacheEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR ns3::sdattackdsr::SdattackdsrRouteCacheEntry::GetVector() const [member function]
    cls.add_method('GetVector', 
                   'ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouteCacheEntry::SetVector(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR v) [member function]
    cls.add_method('SetVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'v')])
    return

def register_Ns3SdattackdsrSdattackdsrRouting_methods(root_module, cls):
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouting::SdattackdsrRouting(ns3::sdattackdsr::SdattackdsrRouting const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRouting const &', 'arg0')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouting::SdattackdsrRouting() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrRouting::AddAckReqHeader(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('AddAckReqHeader', 
                   'uint16_t', 
                   [param('ns3::Ptr< ns3::Packet > &', 'packet'), param('ns3::Ipv4Address', 'nextHop')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::AddRoute(ns3::sdattackdsr::SdattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry &', 'rt')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::AddRoute_Link(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address source) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'source')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): int64_t ns3::sdattackdsr::SdattackdsrRouting::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CallCancelPacketTimer(uint16_t ackId, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelLinkPacketTimer(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelLinkPacketTimer', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelNetworkPacketTimer(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelNetworkPacketTimer', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelPacketAllTimer(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPacketAllTimer', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelPacketTimerNextHop(ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('CancelPacketTimerNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelPassivePacketTimer(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPassivePacketTimer', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::CancelPassiveTimer(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CancelRreqTimer(ns3::Ipv4Address dst, bool isRemove) [member function]
    cls.add_method('CancelRreqTimer', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst'), param('bool', 'isRemove')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::CheckSendBuffer() [member function]
    cls.add_method('CheckSendBuffer', 
                   'void', 
                   [])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    cls.add_method('DeleteAllRoutesIncludeLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrc'), param('ns3::Ipv4Address', 'unreachNode'), param('ns3::Ipv4Address', 'node')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ForwardErrPacket(ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader & rerr, ns3::sdattackdsr::SdattackdsrOptionSRHeader & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardErrPacket', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader &', 'rerr'), param('ns3::sdattackdsr::SdattackdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ForwardPacket(ns3::Ptr<const ns3::Packet> packet, ns3::sdattackdsr::SdattackdsrOptionSRHeader & sourceRoute, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ipv4Address targetAddress, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::sdattackdsr::SdattackdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('ns3::Ipv4Address', 'targetAddress'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::IpL4Protocol::DownTargetCallback ns3::sdattackdsr::SdattackdsrRouting::GetDownTarget() const [member function]
    cls.add_method('GetDownTarget', 
                   'ns3::IpL4Protocol::DownTargetCallback', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::IpL4Protocol::DownTargetCallback6 ns3::sdattackdsr::SdattackdsrRouting::GetDownTarget6() const [member function]
    cls.add_method('GetDownTarget6', 
                   'ns3::IpL4Protocol::DownTargetCallback6', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): std::vector<std::basic_string<char>, std::allocator<std::basic_string<char> > > ns3::sdattackdsr::SdattackdsrRouting::GetElementsFromContext(std::string context) [member function]
    cls.add_method('GetElementsFromContext', 
                   'std::vector< std::string >', 
                   [param('std::string', 'context')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrRouting::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrRouting::GetIPfromID(uint16_t id) [member function]
    cls.add_method('GetIPfromID', 
                   'ns3::Ipv4Address', 
                   [param('uint16_t', 'id')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrRouting::GetIPfromMAC(ns3::Mac48Address address) [member function]
    cls.add_method('GetIPfromMAC', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Mac48Address', 'address')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::NetDevice> ns3::sdattackdsr::SdattackdsrRouting::GetNetDeviceFromContext(std::string context) [member function]
    cls.add_method('GetNetDeviceFromContext', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('std::string', 'context')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::Node> ns3::sdattackdsr::SdattackdsrRouting::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::Node> ns3::sdattackdsr::SdattackdsrRouting::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::sdattackdsr::SdattackdsrOptions> ns3::sdattackdsr::SdattackdsrRouting::GetOption(int optionNumber) [member function]
    cls.add_method('GetOption', 
                   'ns3::Ptr< ns3::sdattackdsr::SdattackdsrOptions >', 
                   [param('int', 'optionNumber')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::sdattackdsr::SdattackdsrPassiveBuffer> ns3::sdattackdsr::SdattackdsrRouting::GetPassiveBuffer() const [member function]
    cls.add_method('GetPassiveBuffer', 
                   'ns3::Ptr< ns3::sdattackdsr::SdattackdsrPassiveBuffer >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRouting::GetPriority(ns3::sdattackdsr::SdattackdsrMessageType messageType) [member function]
    cls.add_method('GetPriority', 
                   'uint32_t', 
                   [param('ns3::sdattackdsr::SdattackdsrMessageType', 'messageType')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): int ns3::sdattackdsr::SdattackdsrRouting::GetProtocolNumber() const [member function]
    cls.add_method('GetProtocolNumber', 
                   'int', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::sdattackdsr::SdattackdsrRreqTable> ns3::sdattackdsr::SdattackdsrRouting::GetRequestTable() const [member function]
    cls.add_method('GetRequestTable', 
                   'ns3::Ptr< ns3::sdattackdsr::SdattackdsrRreqTable >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::sdattackdsr::SdattackdsrRouteCache> ns3::sdattackdsr::SdattackdsrRouting::GetRouteCache() const [member function]
    cls.add_method('GetRouteCache', 
                   'ns3::Ptr< ns3::sdattackdsr::SdattackdsrRouteCache >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrRouting::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::IncreaseRetransTimer() [member function]
    cls.add_method('IncreaseRetransTimer', 
                   'void', 
                   [])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::Insert(ns3::Ptr<ns3::sdattackdsr::SdattackdsrOptions> option) [member function]
    cls.add_method('Insert', 
                   'void', 
                   [param('ns3::Ptr< ns3::sdattackdsr::SdattackdsrOptions >', 'option')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::LinkScheduleTimerExpire(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('LinkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::LookupRoute(ns3::Ipv4Address id, ns3::sdattackdsr::SdattackdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::sdattackdsr::SdattackdsrRouteCacheEntry &', 'rt')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::NetworkScheduleTimerExpire(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('NetworkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::PacketNewRoute(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::PassiveEntryCheck(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft, uint16_t fragmentOffset, uint16_t identification, bool saveEntry) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::PassiveScheduleTimerExpire(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('PassiveScheduleTimerExpire', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::PriorityScheduler(uint32_t priority, bool continueWithFirst) [member function]
    cls.add_method('PriorityScheduler', 
                   'void', 
                   [param('uint32_t', 'priority'), param('bool', 'continueWithFirst')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrRouting::Process(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address dst, uint8_t * nextHeader, uint8_t protocol, bool & isDropped) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::IpL4Protocol::RxStatus ns3::sdattackdsr::SdattackdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::Ipv4Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::Ipv4Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::IpL4Protocol::RxStatus ns3::sdattackdsr::SdattackdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv6Header const & header, ns3::Ptr<ns3::Ipv6Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv6Header const &', 'header'), param('ns3::Ptr< ns3::Ipv6Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::RouteRequestTimerExpire(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SalvagePacket(ns3::Ptr<const ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address dst, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleCachedReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ptr<ns3::Ipv4Route> route, double hops) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleInitialReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleInterRequest(ns3::Ptr<ns3::Packet> packet) [member function]
    cls.add_method('ScheduleInterRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleLinkPacketRetry(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('ScheduleLinkPacketRetry', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleNetworkPacketRetry(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, bool isFirst, uint8_t protocol) [member function]
    cls.add_method('ScheduleNetworkPacketRetry', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('bool', 'isFirst'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SchedulePassivePacketRetry(ns3::sdattackdsr::SdattackdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('SchedulePassivePacketRetry', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::ScheduleRreqRetry(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, bool nonProp, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::Scheduler(uint32_t priority) [member function]
    cls.add_method('Scheduler', 
                   'void', 
                   [param('uint32_t', 'priority')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrRouting::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::Send(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('Send', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendAck(uint16_t ackId, ns3::Ipv4Address destination, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendBuffTimerExpire() [member function]
    cls.add_method('SendBuffTimerExpire', 
                   'void', 
                   [])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendErrorRequest(ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader & rerr, uint8_t protocol) [member function]
    cls.add_method('SendErrorRequest', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader &', 'rerr'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendGratuitousReply(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendInitialRequest(ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    cls.add_method('SendInitialRequest', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendPacket(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendPacketFromBuffer(ns3::sdattackdsr::SdattackdsrOptionSRHeader const & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacketFromBuffer', 
                   'void', 
                   [param('ns3::sdattackdsr::SdattackdsrOptionSRHeader const &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::SendRealDown(ns3::sdattackdsr::SdattackdsrNetworkQueueEntry & newEntry) [member function]
    cls.add_method('SendRealDown', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrNetworkQueueEntry &', 'newEntry')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SendReply', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendRequest(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source) [member function]
    cls.add_method('SendRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SendUnreachError(ns3::Ipv4Address unreachNode, ns3::Ipv4Address destination, ns3::Ipv4Address originalDst, uint8_t salvage, uint8_t protocol) [member function]
    ...
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetDownTarget(ns3::IpL4Protocol::DownTargetCallback callback) [member function]
    cls.add_method('SetDownTarget', 
                   'void', 
                   ...
                   is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetDownTarget6(ns3::IpL4Protocol::DownTargetCallback6 callback) [member function]
    cls.add_method('SetDownTarget6', 
                   'void', 
                   ...
                   is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetPassiveBuffer(ns3::Ptr<ns3::sdattackdsr::SdattackdsrPassiveBuffer> r) [member function]
    cls.add_method('SetPassiveBuffer', 
                   'void', 
                   [param('ns3::Ptr< ns3::sdattackdsr::SdattackdsrPassiveBuffer >', 'r')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetRequestTable(ns3::Ptr<ns3::sdattackdsr::SdattackdsrRreqTable> r) [member function]
    cls.add_method('SetRequestTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::sdattackdsr::SdattackdsrRreqTable >', 'r')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::sdattackdsr::SdattackdsrRouting::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
    cls.add_method('SetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ipv4Address', 'srcAddress')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::SetRouteCache(ns3::Ptr<ns3::sdattackdsr::SdattackdsrRouteCache> r) [member function]
    cls.add_method('SetRouteCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::sdattackdsr::SdattackdsrRouteCache >', 'r')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRouting::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::UseExtends(ns3::sdattackdsr::SdattackdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## sdattackdsr-routing.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRouting::PROT_NUMBER [variable]
    cls.add_static_attribute('PROT_NUMBER', 'uint8_t const', is_const=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## sdattackdsr-routing.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRouting::NotifyNewAggregate() [member function]
    cls.add_method('NotifyNewAggregate', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3SdattackdsrSdattackdsrRoutingHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRoutingHeader::SdattackdsrRoutingHeader(ns3::sdattackdsr::SdattackdsrRoutingHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRoutingHeader const &', 'arg0')])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRoutingHeader::SdattackdsrRoutingHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRoutingHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrRoutingHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRoutingHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrRoutingHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRoutingHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-fs-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRoutingHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3SdattackdsrSdattackdsrRreqTable_methods(root_module, cls):
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRreqTable::SdattackdsrRreqTable(ns3::sdattackdsr::SdattackdsrRreqTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrRreqTable const &', 'arg0')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrRreqTable::SdattackdsrRreqTable() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::CheckUniqueRreqId(ns3::Ipv4Address dst) [member function]
    cls.add_method('CheckUniqueRreqId', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::FindAndUpdate(ns3::Ipv4Address dst) [member function]
    cls.add_method('FindAndUpdate', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRreqTable::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::BlackList * ns3::sdattackdsr::SdattackdsrRreqTable::FindUnidirectional(ns3::Ipv4Address neighbor) [member function]
    cls.add_method('FindUnidirectional', 
                   'ns3::sdattackdsr::BlackList *', 
                   [param('ns3::Ipv4Address', 'neighbor')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetInitHopLimit() const [member function]
    cls.add_method('GetInitHopLimit', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetRreqCnt(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetRreqCnt', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetRreqIdSize() const [member function]
    cls.add_method('GetRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetRreqSize() [member function]
    cls.add_method('GetRreqSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetRreqTableSize() const [member function]
    cls.add_method('GetRreqTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrRreqTable::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrRreqTable::GetUniqueRreqIdSize() const [member function]
    cls.add_method('GetUniqueRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::Invalidate() [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrRreqTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::PurgeNeighbor() [member function]
    cls.add_method('PurgeNeighbor', 
                   'void', 
                   [])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::RemoveLeastExpire() [member function]
    cls.add_method('RemoveLeastExpire', 
                   'void', 
                   [])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::RemoveRreqEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('RemoveRreqEntry', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::SetInitHopLimit(uint32_t hl) [member function]
    cls.add_method('SetInitHopLimit', 
                   'void', 
                   [param('uint32_t', 'hl')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::SetRreqIdSize(uint32_t id) [member function]
    cls.add_method('SetRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::SetRreqTableSize(uint32_t rt) [member function]
    cls.add_method('SetRreqTableSize', 
                   'void', 
                   [param('uint32_t', 'rt')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrRreqTable::SetUniqueRreqIdSize(uint32_t uid) [member function]
    cls.add_method('SetUniqueRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'uid')])
    return

def register_Ns3SdattackdsrSdattackdsrSendBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffEntry::SdattackdsrSendBuffEntry(ns3::sdattackdsr::SdattackdsrSendBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrSendBuffEntry const &', 'arg0')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffEntry::SdattackdsrSendBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrSendBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrSendBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::Ptr<const ns3::Packet> ns3::sdattackdsr::SdattackdsrSendBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrSendBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    return

def register_Ns3SdattackdsrSdattackdsrSendBuffer_methods(root_module, cls):
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffer::SdattackdsrSendBuffer(ns3::sdattackdsr::SdattackdsrSendBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrSendBuffer const &', 'arg0')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrSendBuffer::SdattackdsrSendBuffer() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrSendBuffer::Dequeue(ns3::Ipv4Address dst, ns3::sdattackdsr::SdattackdsrSendBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::sdattackdsr::SdattackdsrSendBuffEntry &', 'entry')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffer::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrSendBuffer::Enqueue(ns3::sdattackdsr::SdattackdsrSendBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::sdattackdsr::SdattackdsrSendBuffEntry &', 'entry')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): bool ns3::sdattackdsr::SdattackdsrSendBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): std::vector<ns3::sdattackdsr::SdattackdsrSendBuffEntry, std::allocator<ns3::sdattackdsr::SdattackdsrSendBuffEntry> > & ns3::sdattackdsr::SdattackdsrSendBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::sdattackdsr::SdattackdsrSendBuffEntry > &', 
                   [])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrSendBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): ns3::Time ns3::sdattackdsr::SdattackdsrSendBuffer::GetSendBufferTimeout() const [member function]
    cls.add_method('GetSendBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrSendBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## sdattackdsr-rsendbuff.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrSendBuffer::SetSendBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetSendBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3SdattackdsrGraReplyEntry_methods(root_module, cls):
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry::GraReplyEntry(ns3::sdattackdsr::GraReplyEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::GraReplyEntry const &', 'arg0')])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry::GraReplyEntry(ns3::Ipv4Address t, ns3::Ipv4Address f, ns3::Time h) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 't'), param('ns3::Ipv4Address', 'f'), param('ns3::Time', 'h')])
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry::m_gratReplyHoldoff [variable]
    cls.add_instance_attribute('m_gratReplyHoldoff', 'ns3::Time', is_const=False)
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry::m_hearFrom [variable]
    cls.add_instance_attribute('m_hearFrom', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-gratuitous-reply-table.h (module 'sdattackdsr'): ns3::sdattackdsr::GraReplyEntry::m_replyTo [variable]
    cls.add_instance_attribute('m_replyTo', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrLink_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::Link::Link(ns3::sdattackdsr::Link const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::Link const &', 'arg0')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::Link::Link(ns3::Ipv4Address ip1, ns3::Ipv4Address ip2) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip1'), param('ns3::Ipv4Address', 'ip2')])
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): void ns3::sdattackdsr::Link::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::Link::m_high [variable]
    cls.add_instance_attribute('m_high', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-rcache.h (module 'sdattackdsr'): ns3::sdattackdsr::Link::m_low [variable]
    cls.add_instance_attribute('m_low', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrLinkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::LinkKey() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::LinkKey(ns3::sdattackdsr::LinkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::LinkKey const &', 'arg0')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::LinkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrNetworkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::NetworkKey() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::NetworkKey(ns3::sdattackdsr::NetworkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::NetworkKey const &', 'arg0')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::NetworkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrPassiveKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::PassiveKey() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::PassiveKey(ns3::sdattackdsr::PassiveKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::PassiveKey const &', 'arg0')])
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::m_segsLeft [variable]
    cls.add_instance_attribute('m_segsLeft', 'uint8_t', is_const=False)
    ## sdattackdsr-maintain-buff.h (module 'sdattackdsr'): ns3::sdattackdsr::PassiveKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SdattackdsrRreqTableEntry_methods(root_module, cls):
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::RreqTableEntry::RreqTableEntry() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::RreqTableEntry::RreqTableEntry(ns3::sdattackdsr::RreqTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::RreqTableEntry const &', 'arg0')])
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::RreqTableEntry::m_expire [variable]
    cls.add_instance_attribute('m_expire', 'ns3::Time', is_const=False)
    ## sdattackdsr-rreq-table.h (module 'sdattackdsr'): ns3::sdattackdsr::RreqTableEntry::m_reqNo [variable]
    cls.add_instance_attribute('m_reqNo', 'uint32_t', is_const=False)
    return

def register_Ns3SdattackdsrSdattackdsrOptionAck_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAck::SdattackdsrOptionAck(ns3::sdattackdsr::SdattackdsrOptionAck const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionAck const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAck::SdattackdsrOptionAck() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAck::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionAck::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAck::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionAck::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAck::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionAckHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckHeader::SdattackdsrOptionAckHeader(ns3::sdattackdsr::SdattackdsrOptionAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionAckHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckHeader::SdattackdsrOptionAckHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetRealDst() const [member function]
    cls.add_method('GetRealDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::Ipv4Address ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetRealSrc() const [member function]
    cls.add_method('GetRealSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckHeader::SetRealDst(ns3::Ipv4Address realDstAddress) [member function]
    cls.add_method('SetRealDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realDstAddress')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckHeader::SetRealSrc(ns3::Ipv4Address realSrcAddress) [member function]
    cls.add_method('SetRealSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realSrcAddress')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionAckReq_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReq::SdattackdsrOptionAckReq(ns3::sdattackdsr::SdattackdsrOptionAckReq const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionAckReq const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReq::SdattackdsrOptionAckReq() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckReq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionAckReq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckReq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionAckReq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionAckReqHeader_methods(root_module, cls):
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::SdattackdsrOptionAckReqHeader(ns3::sdattackdsr::SdattackdsrOptionAckReqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionAckReqHeader const &', 'arg0')])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::SdattackdsrOptionAckReqHeader() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint16_t ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::sdattackdsr::SdattackdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): uint32_t ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-option-header.h (module 'sdattackdsr'): void ns3::sdattackdsr::SdattackdsrOptionAckReqHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    return

def register_Ns3SdattackdsrSdattackdsrOptionPad1_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1::SdattackdsrOptionPad1(ns3::sdattackdsr::SdattackdsrOptionPad1 const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionPad1 const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1::SdattackdsrOptionPad1() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionPad1::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPad1::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionPad1::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPad1::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionPadn_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadn::SdattackdsrOptionPadn(ns3::sdattackdsr::SdattackdsrOptionPadn const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionPadn const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadn::SdattackdsrOptionPadn() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionPadn::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionPadn::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionPadn::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionPadn::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionRerr_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerr::SdattackdsrOptionRerr(ns3::sdattackdsr::SdattackdsrOptionRerr const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRerr const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerr::SdattackdsrOptionRerr() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerr::DoSendError(ns3::Ptr<ns3::Packet> p, ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader & rerr, uint32_t rerrSize, ns3::Ipv4Address ipv4Address, uint8_t protocol) [member function]
    cls.add_method('DoSendError', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::sdattackdsr::SdattackdsrOptionRerrUnreachHeader &', 'rerr'), param('uint32_t', 'rerrSize'), param('ns3::Ipv4Address', 'ipv4Address'), param('uint8_t', 'protocol')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerr::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerr::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRerr::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRerr::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRerr::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionRrep_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrep::SdattackdsrOptionRrep(ns3::sdattackdsr::SdattackdsrOptionRrep const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRrep const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrep::SdattackdsrOptionRrep() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRrep::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRrep::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRrep::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRrep::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRrep::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionRreq_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreq::SdattackdsrOptionRreq(ns3::sdattackdsr::SdattackdsrOptionRreq const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionRreq const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreq::SdattackdsrOptionRreq() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRreq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRreq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionRreq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionRreq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionRreq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3SdattackdsrSdattackdsrOptionSR_methods(root_module, cls):
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSR::SdattackdsrOptionSR(ns3::sdattackdsr::SdattackdsrOptionSR const & arg0) [constructor]
    cls.add_constructor([param('ns3::sdattackdsr::SdattackdsrOptionSR const &', 'arg0')])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSR::SdattackdsrOptionSR() [constructor]
    cls.add_constructor([])
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionSR::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionSR::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): static ns3::TypeId ns3::sdattackdsr::SdattackdsrOptionSR::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): uint8_t ns3::sdattackdsr::SdattackdsrOptionSR::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> sdattackdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'sdattackdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## sdattackdsr-options.h (module 'sdattackdsr'): ns3::sdattackdsr::SdattackdsrOptionSR::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return
...
def register_functions(root_module):
    ...
    register_functions_ns3_sdattackdsr(module.add_cpp_namespace('sdattackdsr'), root_module)
...
def register_functions_ns3_sdattackdsr(module, root_module):
    return
