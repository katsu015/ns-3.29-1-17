...
class SdattackdsrOptions : public Object
{
public:
  /**
   ...
   *
   * Called from SdattackdsrRouting::Receive.
   * \param packet the packet
   * \param sdattackdsrP  the clean packet with payload
   ...
   */
  virtual uint8_t Process (Ptr<Packet> packet, Ptr<Packet> sdattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource) = 0;
...
protected:
   ...
   */
  Ptr<sdattackdsr::SdattackdsrRreqTable> m_rreqTable;
  /**
   * \brief The route cache table.
   */
  Ptr<sdattackdsr::SdattackdsrRouteCache> m_routeCache;
  /**
   ...
   */
  TracedCallback <const SdattackdsrOptionSRHeader &> m_rxPacketTrace;
...
/**
 * \class SdattackdsrOptionPad1
 * \brief Sdattackdsr Option Pad1
 */
class SdattackdsrOptionPad1 : public SdattackdsrOptions
{
public:
  /**
  ...
  SdattackdsrOptionPad1 ();
  virtual ~SdattackdsrOptionPad1 ();

  virtual uint8_t GetOptionNumber () const;
  virtual uint8_t Process (Ptr<Packet> packet, Ptr<Packet> sdattackdsrP, Ipv4Address ipv4Address, Ipv4Address source, Ipv4Header const& ipv4Header, uint8_t protocol, bool& isPromisc, Ipv4Address promiscSource);
};

/**
 * \class SdattackdsrOptionPadn
 * \brief IPv4 Option Padn
 */
class SdattackdsrOptionPadn : public SdattackdsrOptions
{
public:
  /**
  ...
  SdattackdsrOptionPadn ();
  virtual ~SdattackdsrOptionPadn ();
...
/**
 * \class SdattackdsrOptionRreq
 * \brief Sdattackdsr Option Rreq
 */
class SdattackdsrOptionRreq : public SdattackdsrOptions
{
public:
  /**
   ...
   * \brief Constructor.
   */
  SdattackdsrOptionRreq ();
  /**
   * \brief Destructor.
   */
  virtual ~SdattackdsrOptionRreq ();
...
/**
 * \class SdattackdsrOptionRrep
 * \brief Sdattackdsr Option Route Reply
 */
class SdattackdsrOptionRrep : public SdattackdsrOptions
{
public:
  /**
  ...
  SdattackdsrOptionRrep ();
  virtual ~SdattackdsrOptionRrep ();
...
/**
 * \class SdattackdsrOptionSR
 * \brief Sdattackdsr Option Source Route
 */
class SdattackdsrOptionSR : public SdattackdsrOptions
{
public:
  /**
...
/**
 * \class SdattackdsrOptionRerr
 * \brief Sdattackdsr Option Route Error
 */
class SdattackdsrOptionRerr : public SdattackdsrOptions
{
public:
  /**
   * \brief Sdattackdsr Route Error option number.
   */
  ...
  SdattackdsrOptionRerr ();
  virtual ~SdattackdsrOptionRerr ();
   ...
   *
   * \param p the packet
   * \param rerr  the SdattackdsrOptionRerrUnreachHeader header
   * \param rerrSize the route error header size
   * \param ipv4Address ipv4 address of our own
   * \param protocol the protocol number of the up layer
   * \return the processed size
   */
  uint8_t DoSendError (Ptr<Packet> p, SdattackdsrOptionRerrUnreachHeader &rerr, uint32_t rerrSize, Ipv4Address ipv4Address, uint8_t protocol);
...
/**
 * \class SdattackdsrOptionAckReq
 * \brief Sdattackdsr Option
 */
class SdattackdsrOptionAckReq : public SdattackdsrOptions
{
public:
  /**
   * \brief Sdattackdsr ack request option number.
   */
  ...
  SdattackdsrOptionAckReq ();
  virtual ~SdattackdsrOptionAckReq ();
...
/**
 * \class SdattackdsrOptionAck
 * \brief Sdattackdsr Option Ack
 */
class SdattackdsrOptionAck : public SdattackdsrOptions
{
public:
  /**
   * \brief The Sdattackdsr Ack option number.
   */
  ...
  SdattackdsrOptionAck ();
  virtual ~SdattackdsrOptionAck ();
