 ...
 */
class SdattackdsrErrorBuffEntry
{
public:
  /**
   * Create an SdattackdsrErrorBuffEntry with the given parameters.
   *
   * \param pa packet
   ...
   */
  SdattackdsrErrorBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (), Ipv4Address s = Ipv4Address (),
   ...
   * \param o another SdattackdsrErrorBuffEntry
   * \return true if equal
   */
  bool operator== (SdattackdsrErrorBuffEntry const & o) const
  {
 ...
 */
/************************************************************************************************************************/
class SdattackdsrErrorBuffer
{
public:
  /**
   * Default constructor
   */
  SdattackdsrErrorBuffer ()
  {
  }
  /**
   ...
   */
  bool Enqueue (SdattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  bool Dequeue (Ipv4Address dst, SdattackdsrErrorBuffEntry & entry);
  /**
   ...
   */
  std::vector<SdattackdsrErrorBuffEntry> & GetBuffer ()
  {
...
private:
  ...
  std::vector<SdattackdsrErrorBuffEntry> m_errorBuffer;
   ...
   */
  ///
  void Drop (SdattackdsrErrorBuffEntry en, std::string reason);
  /**
   * Notify that packet is dropped from queue by link error
   * \param en Error Buffer Entry
   * \param reason Drop reason.
   */
  void DropLink (SdattackdsrErrorBuffEntry en, std::string reason);
   ...
   */
  ///
  static bool LinkEqual (SdattackdsrErrorBuffEntry en, const std::vector<Ipv4Address> link)
  {
