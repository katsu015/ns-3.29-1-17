...
NS_LOG_COMPONENT_DEFINE ("SdattackdsrMaintainBuffer");

namespace sdattackdsr {

uint32_t
SdattackdsrMaintainBuffer::GetSize ()
{
  Purge ();
...
bool
SdattackdsrMaintainBuffer::Enqueue (SdattackdsrMaintainBuffEntry & entry)
{
  Purge ();
  for (std::vector<SdattackdsrMaintainBuffEntry>::const_iterator i = m_maintainBuffer.begin (); i
...
void
SdattackdsrMaintainBuffer::DropPacketWithNextHop (Ipv4Address nextHop)
{
  ...
  m_maintainBuffer.erase (std::remove_if (m_maintainBuffer.begin (), m_maintainBuffer.end (),
                                          std::bind2nd (std::ptr_fun (SdattackdsrMaintainBuffer::IsEqual), nextHop)), m_maintainBuffer.end ());
}

bool
SdattackdsrMaintainBuffer::Dequeue (Ipv4Address nextHop, SdattackdsrMaintainBuffEntry & entry)
{
  Purge ();
  for (std::vector<SdattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i != m_maintainBuffer.end (); ++i)
    {
...
bool
SdattackdsrMaintainBuffer::Find (Ipv4Address nextHop)
{
  for (std::vector<SdattackdsrMaintainBuffEntry>::const_iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
SdattackdsrMaintainBuffer::AllEqual (SdattackdsrMaintainBuffEntry & entry)
{
  for (std::vector<SdattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
SdattackdsrMaintainBuffer::NetworkEqual (SdattackdsrMaintainBuffEntry & entry)
{
  for (std::vector<SdattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
    {
...
bool
SdattackdsrMaintainBuffer::PromiscEqual (SdattackdsrMaintainBuffEntry & entry)
{
...
bool
SdattackdsrMaintainBuffer::LinkEqual (SdattackdsrMaintainBuffEntry & entry)
{
  NS_LOG_DEBUG ("The maintenance buffer size " << m_maintainBuffer.size ());
  for (std::vector<SdattackdsrMaintainBuffEntry>::iterator i = m_maintainBuffer.begin (); i
       != m_maintainBuffer.end (); ++i)
...
struct IsExpired
{
   ...
   */
  bool
  operator() (SdattackdsrMaintainBuffEntry const & e) const
  {
...
void
SdattackdsrMaintainBuffer::Purge ()
{
