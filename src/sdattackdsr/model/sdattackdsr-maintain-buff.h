 ...
 */
class SdattackdsrMaintainBuffEntry
{
public:
  /**
   * Construct a SdattackdsrMaintainBuffEntry with the given parameters
   *
   * \param pa packet
   ...
   */
  SdattackdsrMaintainBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address us = Ipv4Address (),
...
public:
  ...
  bool AllEqual (SdattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for link ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool LinkEqual (SdattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for network ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool NetworkEqual (SdattackdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for promiscuous ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool PromiscEqual (SdattackdsrMaintainBuffEntry & entry);

private:
  /// The vector of maintain buffer entries
  std::vector<SdattackdsrMaintainBuffEntry> m_maintainBuffer;
  ...
  static bool IsEqual (SdattackdsrMaintainBuffEntry en, const Ipv4Address nextHop)
  {
