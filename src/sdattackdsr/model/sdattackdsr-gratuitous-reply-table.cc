...
NS_LOG_COMPONENT_DEFINE ("SdattackdsrGraReplyTable");

namespace sdattackdsr {

NS_OBJECT_ENSURE_REGISTERED (SdattackdsrGraReply);

TypeId SdattackdsrGraReply::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::sdattackdsr::SdattackdsrGraReply")
    .SetParent<Object> ()
    .SetGroupName ("Sdattackdsr")
    .AddConstructor<SdattackdsrGraReply> ()
  ;
  return tid;
}

SdattackdsrGraReply::SdattackdsrGraReply ()
{
}
...
bool
SdattackdsrGraReply::FindAndUpdate (Ipv4Address replyTo, Ipv4Address replyFrom, Time gratReplyHoldoff)
{
...
bool
SdattackdsrGraReply::AddEntry (GraReplyEntry & graTableEntry)
{
